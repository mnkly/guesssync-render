...
const E159CFG = { items: PLACE_EMOJI, facts: PLACE_EMOJI_FACTS, topicWord: "FICTIONAL PLACE", topicPlural: "FICTIONAL PLACES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e159-", introVo: "vo-intro-place", coldSlug: "", theme: 6 };
const E160CFG = { items: SCIENTIST_EMOJI, facts: SCIENTIST_EMOJI_FACTS, topicWord: "SCIENTIST", topicPlural: "SCIENTISTS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e160-", introVo: "vo-intro-scientist", coldSlug: "", theme: 6 };
const E161CFG = { items: INVENTION_EMOJI, facts: INVENTION_EMOJI_FACTS, topicWord: "INVENTION", topicPlural: "INVENTIONS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e161-", introVo: "vo-intro-invention", coldSlug: "", theme: 6 };
const E162CFG = { items: DUO_EMOJI, facts: DUO_EMOJI_FACTS, topicWord: "FAMOUS DUO", topicPlural: "FAMOUS DUOS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e162-", introVo: "vo-intro-duo", coldSlug: "", theme: 6 };
const E163CFG = { items: ARTIFACT_EMOJI, facts: ARTIFACT_EMOJI_FACTS, topicWord: "LEGENDARY ARTIFACT", topicPlural: "LEGENDARY ARTIFACTS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e163-", introVo: "vo-intro-artifact", coldSlug: "", theme: 6 };
const E164CFG = { items: PAINTING_EMOJI, facts: PAINTING_EMOJI_FACTS, topicWord: "PAINTING", topicPlural: "PAINTINGS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e164-", introVo: "vo-intro-painting", coldSlug: "", theme: 6 };
const E165CFG = { items: PHOBIA_EMOJI, facts: PHOBIA_EMOJI_FACTS, topicWord: "PHOBIA", topicPlural: "PHOBIAS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e165-", introVo: "vo-intro-phobia", coldSlug: "", theme: 6 };
const E166CFG = { items: MASCOT_EMOJI, facts: MASCOT_EMOJI_FACTS, topicWord: "BRAND MASCOT", topicPlural: "BRAND MASCOTS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e166-", introVo: "vo-intro-mascot", coldSlug: "", theme: 6 };
const E167CFG = { items: INSTRUMENT_EMOJI, facts: INSTRUMENT_EMOJI_FACTS, topicWord: "INSTRUMENT", topicPlural: "INSTRUMENTS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e167-", introVo: "vo-intro-instrument", coldSlug: "", theme: 6 };
const E168CFG = { items: MOVIE_EMOJI_3, facts: MOVIE_EMOJI_3_FACTS, topicWord: "MOVIE", topicPlural: "MOVIES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e168-", introVo: "vo-intro-movie3", coldSlug: "", theme: 6 };
const E169CFG = { items: VIDEOGAME_EMOJI_3, facts: VIDEOGAME_EMOJI_3_FACTS, topicWord: "GAME", topicPlural: "GAMES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e169-", introVo: "vo-intro-game3", coldSlug: "", theme: 6 };
const E170CFG = { items: SUPERPOWER_EMOJI, facts: SUPERPOWER_EMOJI_FACTS, topicWord: "SUPERPOWER", topicPlural: "SUPERPOWERS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e170-", introVo: "vo-intro-power", coldSlug: "", theme: 6 };
const E171CFG = { items: SONG_EMOJI_3, facts: SONG_EMOJI_3_FACTS, topicWord: "SONG", topicPlural: "SONGS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e171-", introVo: "vo-intro-song3", coldSlug: "", theme: 6 };
const E172CFG = { items: TV_EMOJI_3, facts: TV_EMOJI_3_FACTS, topicWord: "TV SHOW", topicPlural: "TV SHOWS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e172-", introVo: "vo-intro-tv3", coldSlug: "", theme: 6 };
const E173CFG = { items: BOOK_EMOJI_3, facts: BOOK_EMOJI_3_FACTS, topicWord: "BOOK", topicPlural: "BOOKS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e173-", introVo: "vo-intro-book3", coldSlug: "", theme: 6 };
const E174CFG = { items: BRAND_EMOJI_3, facts: BRAND_EMOJI_3_FACTS, topicWord: "BRAND", topicPlural: "BRANDS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e174-", introVo: "vo-intro-brand3", coldSlug: "", theme: 6 };
const E175CFG = { items: FOOD_EMOJI_3, facts: FOOD_EMOJI_3_FACTS, topicWord: "FOOD", topicPlural: "FOODS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e175-", introVo: "vo-intro-food3", coldSlug: "", theme: 6 };
const E176CFG = { items: HERO_EMOJI_2, facts: HERO_EMOJI_2_FACTS, topicWord: "SUPERHERO", topicPlural: "SUPERHEROES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e176-", introVo: "vo-intro-hero2", coldSlug: "", theme: 6 };
const E177CFG = { items: DISNEY_EMOJI_2, facts: DISNEY_EMOJI_2_FACTS, topicWord: "DISNEY", topicPlural: "DISNEY", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e177-", introVo: "vo-intro-disney2", coldSlug: "", theme: 6 };
const E178CFG = { items: ANIME_EMOJI_2, facts: ANIME_EMOJI_2_FACTS, topicWord: "ANIME", topicPlural: "ANIME", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e178-", introVo: "vo-intro-anime2", coldSlug: "", theme: 6 };
const E179CFG = { items: CARTOON_EMOJI_2, facts: CARTOON_EMOJI_2_FACTS, topicWord: "CARTOON", topicPlural: "CARTOONS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e179-", introVo: "vo-intro-cartoon2", coldSlug: "", theme: 6 };
const E180CFG = { items: MOVIE_EMOJI_4, facts: MOVIE_EMOJI_4_FACTS, topicWord: "MOVIE", topicPlural: "MOVIES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e180-", introVo: "vo-intro-movie4", coldSlug: "", theme: 6 };
const E181CFG = { items: SPORTS_EMOJI_2, facts: SPORTS_EMOJI_2_FACTS, topicWord: "SPORT", topicPlural: "SPORTS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e181-", introVo: "vo-intro-sport2", coldSlug: "", theme: 6 };
const E182CFG = { items: LANDMARK_EMOJI, facts: LANDMARK_EMOJI_FACTS, topicWord: "LANDMARK", topicPlural: "LANDMARKS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e182-", introVo: "vo-intro-elandmark", coldSlug: "", theme: 6 };
...
const E189CFG = { items: ANIMAL_EMOJI_3, facts: ANIMAL_EMOJI_3_FACTS, topicWord: "ANIMAL", topicPlural: "ANIMALS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e189-", introVo: "vo-intro-eanimal3", coldSlug: "", theme: 6 };
const E190CFG = { items: FOOD_EMOJI_4, facts: FOOD_EMOJI_4_FACTS, topicWord: "FOOD", topicPlural: "FOODS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e190-", introVo: "vo-intro-efood4", coldSlug: "", theme: 6 };
const E191CFG = { items: SONG_EMOJI_4, facts: SONG_EMOJI_4_FACTS, topicWord: "SONG", topicPlural: "SONGS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e191-", introVo: "vo-intro-esong4", coldSlug: "", theme: 6 };
const E192CFG = { items: MOVIE_EMOJI_5, facts: MOVIE_EMOJI_5_FACTS, topicWord: "MOVIE", topicPlural: "MOVIES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e192-", introVo: "vo-intro-emovie5", coldSlug: "", theme: 6 };
const E193CFG = { items: TV_EMOJI_4, facts: TV_EMOJI_4_FACTS, topicWord: "TV SHOW", topicPlural: "TV SHOWS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e193-", introVo: "vo-intro-etv4", coldSlug: "", theme: 6 };
const E194CFG = { items: VIDEOGAME_EMOJI_4, facts: VIDEOGAME_EMOJI_4_FACTS, topicWord: "GAME", topicPlural: "GAMES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e194-", introVo: "vo-intro-egame4", coldSlug: "", theme: 6 };
const E195CFG = { items: HERO_EMOJI_3, facts: HERO_EMOJI_3_FACTS, topicWord: "SUPERHERO", topicPlural: "SUPERHEROES", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e195-", introVo: "vo-intro-eheroes3", coldSlug: "", theme: 6 };
const E196CFG = { items: BRAND_EMOJI_4, facts: BRAND_EMOJI_4_FACTS, topicWord: "BRAND", topicPlural: "BRANDS", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e196-", introVo: "vo-intro-ebrand4", coldSlug: "", theme: 6 };
const E197CFG = { items: ANIME_EMOJI_3, facts: ANIME_EMOJI_3_FACTS, topicWord: "ANIME", topicPlural: "ANIME", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e197-", introVo: "vo-intro-eanime3", coldSlug: "", theme: 6 };
const E198CFG = { items: DISNEY_EMOJI_3, facts: DISNEY_EMOJI_3_FACTS, topicWord: "DISNEY", topicPlural: "Disney characters", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e198-", introVo: "vo-intro-edisney3", coldSlug: "", theme: 6 };
const E199CFG = { items: CARTOON_EMOJI_3, facts: CARTOON_EMOJI_3_FACTS, topicWord: "CARTOON", topicPlural: "cartoon characters", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e199-", introVo: "vo-intro-ecartoon3", coldSlug: "", theme: 6 };
const E200CFG = { items: BOOK_EMOJI_4, facts: BOOK_EMOJI_4_FACTS, topicWord: "BOOK", topicPlural: "books", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e200-", introVo: "vo-intro-ebook4", coldSlug: "", theme: 6 };
const E201CFG = { items: LANDMARK_EMOJI_2, facts: LANDMARK_EMOJI_2_FACTS, topicWord: "LANDMARK", topicPlural: "landmarks", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e201-", introVo: "vo-intro-elandmark2", coldSlug: "", theme: 6 };
const E202CFG = { items: SPORTS_EMOJI_3, facts: SPORTS_EMOJI_3_FACTS, topicWord: "SPORT", topicPlural: "sports", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e202-", introVo: "vo-intro-esport3", coldSlug: "", theme: 6 };
const E203CFG = { items: JOBS_EMOJI_3, facts: JOBS_EMOJI_3_FACTS, topicWord: "JOB", topicPlural: "jobs", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e203-", introVo: "vo-intro-ejobs3", coldSlug: "", theme: 6 };
const E204CFG = { items: FRUIT_EMOJI_2, facts: FRUIT_EMOJI_2_FACTS, topicWord: "FRUIT OR VEG", topicPlural: "fruits & veg", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e204-", introVo: "vo-intro-efruit2", coldSlug: "", theme: 6 };
const E205CFG = { items: SEACREATURE_EMOJI_2, facts: SEACREATURE_EMOJI_2_FACTS, topicWord: "SEA CREATURE", topicPlural: "sea creatures", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e205-", introVo: "vo-intro-eseacreature2", coldSlug: "", theme: 6 };
const E206CFG = { items: INSTRUMENT_EMOJI_2, facts: INSTRUMENT_EMOJI_2_FACTS, topicWord: "INSTRUMENT", topicPlural: "instruments", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e206-", introVo: "vo-intro-einstrument2", coldSlug: "", theme: 6 };
const E207CFG = { items: VILLAIN_EMOJI_3, facts: VILLAIN_EMOJI_3_FACTS, topicWord: "VILLAIN", topicPlural: "villains", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e207-", introVo: "vo-intro-evillain3", coldSlug: "", theme: 6 };
const E208CFG = { items: MYTHCREATURE_EMOJI_3, facts: MYTHCREATURE_EMOJI_3_FACTS, topicWord: "MYTHICAL CREATURE", topicPlural: "mythical creatures", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e208-", introVo: "vo-intro-emythcreature3", coldSlug: "", theme: 6 };
const E209CFG = { items: WEATHER_EMOJI_2, facts: WEATHER_EMOJI_2_FACTS, topicWord: "WEATHER", topicPlural: "weather phenomena", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e209-", introVo: "vo-intro-eweather2", coldSlug: "", theme: 6 };
const E210CFG = { items: DESSERT_EMOJI_3, facts: DESSERT_EMOJI_3_FACTS, topicWord: "DESSERT", topicPlural: "desserts", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e210-", introVo: "vo-intro-edessert3", coldSlug: "", theme: 6 };
const E211CFG = { items: VEHICLE_EMOJI_3, facts: VEHICLE_EMOJI_3_FACTS, topicWord: "VEHICLE", topicPlural: "vehicles", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e211-", introVo: "vo-intro-evehicle3", coldSlug: "", theme: 6 };
const E212CFG = { items: ANIMAL_EMOJI_4, facts: ANIMAL_EMOJI_4_FACTS, topicWord: "ANIMAL", topicPlural: "animals", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e212-", introVo: "vo-intro-eanimal4", coldSlug: "", theme: 6 };
const E213CFG = { items: FOOD_EMOJI_5, facts: FOOD_EMOJI_5_FACTS, topicWord: "FOOD", topicPlural: "dishes", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e213-", introVo: "vo-intro-efood5", coldSlug: "", theme: 6 };
const E214CFG = { items: SONG_EMOJI_5, facts: SONG_EMOJI_5_FACTS, topicWord: "SONG", topicPlural: "songs", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e214-", introVo: "vo-intro-esong5", coldSlug: "", theme: 6 };
const E215CFG = { items: MOVIE_EMOJI_6, facts: MOVIE_EMOJI_6_FACTS, topicWord: "MOVIE", topicPlural: "movies", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e215-", introVo: "vo-intro-emovie6", coldSlug: "", theme: 6 };
const E216CFG = { items: HOLIDAY_EMOJI_2, facts: HOLIDAY_EMOJI_2_FACTS, topicWord: "HOLIDAY", topicPlural: "holidays", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e216-", introVo: "vo-intro-eholiday2", coldSlug: "", theme: 6 };
const E217CFG = { items: CLOTHING_EMOJI_2, facts: CLOTHING_EMOJI_2_FACTS, topicWord: "CLOTHING", topicPlural: "clothing items", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e217-", introVo: "vo-intro-eclothing2", coldSlug: "", theme: 6 };
const E218CFG = { items: TOY_EMOJI_2, facts: TOY_EMOJI_2_FACTS, topicWord: "TOY", topicPlural: "toys", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e218-", introVo: "vo-intro-etoy2", coldSlug: "", theme: 6 };
const E219CFG = { items: CITY_EMOJI_2, facts: CITY_EMOJI_2_FACTS, topicWord: "CITY", topicPlural: "cities", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e219-", introVo: "vo-intro-ecity2", coldSlug: "", theme: 6 };
const E220CFG = { items: DRINK_EMOJI_2, facts: DRINK_EMOJI_2_FACTS, topicWord: "DRINK", topicPlural: "drinks", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e220-", introVo: "vo-intro-edrink2", coldSlug: "", theme: 6 };
const E221CFG = { items: BOARDGAME_EMOJI_2, facts: BOARDGAME_EMOJI_2_FACTS, topicWord: "BOARD GAME", topicPlural: "board games", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e221-", introVo: "vo-intro-eboardgame2", coldSlug: "", theme: 6 };
const E222CFG = { items: ANIMAL_EMOJI5, facts: ANIMAL_EMOJI5_FACTS, topicWord: "ANIMAL", topicPlural: "animals", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e222-", introVo: "vo-intro-eanimal5", coldSlug: "", theme: 6 };
const E223CFG = { items: MOVIE_EMOJI7, facts: MOVIE_EMOJI7_FACTS, topicWord: "MOVIE", topicPlural: "movies", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e223-", introVo: "vo-intro-emovie7", coldSlug: "", theme: 6 };
const E224CFG = { items: CARTOON_EMOJI4, facts: CARTOON_EMOJI4_FACTS, topicWord: "CARTOON", topicPlural: "cartoons", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e224-", introVo: "vo-intro-ecartoon4", coldSlug: "", theme: 6 };
const E225CFG = { items: TV_EMOJI5, facts: TV_EMOJI5_FACTS, topicWord: "TV SHOW", topicPlural: "TV shows", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e225-", introVo: "vo-intro-etv5", coldSlug: "", theme: 6 };
const E226CFG = { items: SONG_EMOJI6, facts: SONG_EMOJI6_FACTS, topicWord: "SONG", topicPlural: "songs", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e226-", introVo: "vo-intro-esong6", coldSlug: "", theme: 6 };
const E227CFG = { items: BRAND_EMOJI5, facts: BRAND_EMOJI5_FACTS, topicWord: "BRAND", topicPlural: "brands", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e227-", introVo: "vo-intro-ebrand5", coldSlug: "", theme: 6 };
const E228CFG = { items: VIDEOGAME_EMOJI5, facts: VIDEOGAME_EMOJI5_FACTS, topicWord: "GAME", topicPlural: "games", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e228-", introVo: "vo-intro-evideogame5", coldSlug: "", theme: 6 };
const E229CFG = { items: BOOK_EMOJI5, facts: BOOK_EMOJI5_FACTS, topicWord: "BOOK", topicPlural: "books", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e229-", introVo: "vo-intro-ebook5", coldSlug: "", theme: 6 };
const E230CFG = { items: DISNEY_EMOJI4, facts: DISNEY_EMOJI4_FACTS, topicWord: "DISNEY", topicPlural: "Disney characters", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e230-", introVo: "vo-intro-edisney4", coldSlug: "", theme: 6 };
const E231CFG = { items: SPORTS_EMOJI4, facts: SPORTS_EMOJI4_FACTS, topicWord: "SPORT", topicPlural: "sports", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e231-", introVo: "vo-intro-esport4", coldSlug: "", theme: 6 };
const E232CFG = { items: FOOD_EMOJI6, facts: FOOD_EMOJI6_FACTS, topicWord: "FOOD", topicPlural: "foods", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e232-", introVo: "vo-intro-efood6", coldSlug: "", theme: 6 };
const E233CFG = { items: ANIME_EMOJI4, facts: ANIME_EMOJI4_FACTS, topicWord: "ANIME", topicPlural: "anime", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e233-", introVo: "vo-intro-eanime4", coldSlug: "", theme: 6 };
const E234CFG = { items: MOVIE_EMOJI8, facts: MOVIE_EMOJI8_FACTS, topicWord: "MOVIE", topicPlural: "movies", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e234-", introVo: "vo-intro-emovie8", coldSlug: "", theme: 6 };
const E235CFG = { items: TV_EMOJI6, facts: TV_EMOJI6_FACTS, topicWord: "TV SHOW", topicPlural: "TV shows", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e235-", introVo: "vo-intro-etv6", coldSlug: "", theme: 6 };
const E236CFG = { items: VILLAIN_EMOJI4, facts: VILLAIN_EMOJI4_FACTS, topicWord: "VILLAIN", topicPlural: "villains", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e236-", introVo: "vo-intro-evillain4", coldSlug: "", theme: 6 };
const E237CFG = { items: SONG_EMOJI7, facts: SONG_EMOJI7_FACTS, topicWord: "SONG", topicPlural: "songs", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e237-", introVo: "vo-intro-esong7", coldSlug: "", theme: 6 };
const E238CFG = { items: ANIMAL_EMOJI6, facts: ANIMAL_EMOJI6_FACTS, topicWord: "ANIMAL", topicPlural: "animals", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e238-", introVo: "vo-intro-eanimal6", coldSlug: "", theme: 6 };
const E239CFG = { items: BRAND_EMOJI6, facts: BRAND_EMOJI6_FACTS, topicWord: "BRAND", topicPlural: "brands", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e239-", introVo: "vo-intro-ebrand6", coldSlug: "", theme: 6 };
const E240CFG = { items: MOVIE_EMOJI9, facts: MOVIE_EMOJI9_FACTS, topicWord: "MOVIE", topicPlural: "movies", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e240-", introVo: "vo-intro-emovie9", coldSlug: "", theme: 6 };
const E241CFG = { items: VIDEOGAME_EMOJI6, facts: VIDEOGAME_EMOJI6_FACTS, topicWord: "GAME", topicPlural: "games", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e241-", introVo: "vo-intro-evideogame6", coldSlug: "", theme: 6 };
const E242CFG = { items: CARTOON_EMOJI5, facts: CARTOON_EMOJI5_FACTS, topicWord: "CARTOON", topicPlural: "cartoons", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e242-", introVo: "vo-intro-ecartoon5", coldSlug: "", theme: 6 };
const E243CFG = { items: SONG_EMOJI8, facts: SONG_EMOJI8_FACTS, topicWord: "SONG", topicPlural: "songs", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e243-", introVo: "vo-intro-esong8", coldSlug: "", theme: 6 };
const E244CFG = { items: ANIMAL_EMOJI7, facts: ANIMAL_EMOJI7_FACTS, topicWord: "ANIMAL", topicPlural: "animals", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e244-", introVo: "vo-intro-eanimal7", coldSlug: "", theme: 6 };
const E245CFG = { items: MOVIE_EMOJI10, facts: MOVIE_EMOJI10_FACTS, topicWord: "MOVIE", topicPlural: "movies", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e245-", introVo: "vo-intro-emovie10", coldSlug: "", theme: 6 };
const E246CFG = { items: TV_EMOJI7, facts: TV_EMOJI7_FACTS, topicWord: "TV SHOW", topicPlural: "TV shows", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e246-", introVo: "vo-intro-etv7", coldSlug: "", theme: 6 };
const E247CFG = { items: FOOD_EMOJI7, facts: FOOD_EMOJI7_FACTS, topicWord: "FOOD", topicPlural: "foods", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e247-", introVo: "vo-intro-efood7", coldSlug: "", theme: 6 };
const E248CFG = { items: VIDEOGAME_EMOJI7, facts: VIDEOGAME_EMOJI7_FACTS, topicWord: "GAME", topicPlural: "games", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e248-", introVo: "vo-intro-evideogame7", coldSlug: "", theme: 6 };
const E249CFG = { items: ANIME_EMOJI5, facts: ANIME_EMOJI5_FACTS, topicWord: "ANIME", topicPlural: "anime", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e249-", introVo: "vo-intro-eanime5", coldSlug: "", theme: 6 };
const E250CFG = { items: DISNEY_EMOJI5, facts: DISNEY_EMOJI5_FACTS, topicWord: "DISNEY", topicPlural: "Disney characters", isEmoji: true, nameField: "title", slugKey: "id", voKey: "id", voPrefix: "e250-", introVo: "vo-intro-edisney5", coldSlug: "", theme: 6 };
...
import { PLACE_EMOJI } from "./Quiz/placeEmojiData";
import { PLACE_EMOJI_FACTS } from "./Quiz/placeEmojiFacts";
import { SCIENTIST_EMOJI } from "./Quiz/scientistEmojiData";
import { SCIENTIST_EMOJI_FACTS } from "./Quiz/scientistEmojiFacts";
import { INVENTION_EMOJI } from "./Quiz/inventionEmojiData";
import { INVENTION_EMOJI_FACTS } from "./Quiz/inventionEmojiFacts";
import { DUO_EMOJI } from "./Quiz/duoEmojiData";
import { DUO_EMOJI_FACTS } from "./Quiz/duoEmojiFacts";
import { ARTIFACT_EMOJI } from "./Quiz/artifactEmojiData";
import { ARTIFACT_EMOJI_FACTS } from "./Quiz/artifactEmojiFacts";
import { PAINTING_EMOJI } from "./Quiz/paintingEmojiData";
import { PAINTING_EMOJI_FACTS } from "./Quiz/paintingEmojiFacts";
import { PHOBIA_EMOJI } from "./Quiz/phobiaEmojiData";
import { PHOBIA_EMOJI_FACTS } from "./Quiz/phobiaEmojiFacts";
import { MASCOT_EMOJI } from "./Quiz/mascotEmojiData";
import { MASCOT_EMOJI_FACTS } from "./Quiz/mascotEmojiFacts";
import { INSTRUMENT_EMOJI } from "./Quiz/instrumentEmojiData";
import { INSTRUMENT_EMOJI_FACTS } from "./Quiz/instrumentEmojiFacts";
import { MOVIE_EMOJI_3 } from "./Quiz/movieEmoji3Data";
import { MOVIE_EMOJI_3_FACTS } from "./Quiz/movieEmoji3Facts";
import { VIDEOGAME_EMOJI_3 } from "./Quiz/videogameEmoji3Data";
import { VIDEOGAME_EMOJI_3_FACTS } from "./Quiz/videogameEmoji3Facts";
import { SUPERPOWER_EMOJI } from "./Quiz/superpowerEmojiData";
import { SUPERPOWER_EMOJI_FACTS } from "./Quiz/superpowerEmojiFacts";
import { SONG_EMOJI_3 } from "./Quiz/songEmoji3Data";
import { SONG_EMOJI_3_FACTS } from "./Quiz/songEmoji3Facts";
import { TV_EMOJI_3 } from "./Quiz/tvEmoji3Data";
import { TV_EMOJI_3_FACTS } from "./Quiz/tvEmoji3Facts";
import { BOOK_EMOJI_3 } from "./Quiz/bookEmoji3Data";
import { BOOK_EMOJI_3_FACTS } from "./Quiz/bookEmoji3Facts";
import { BRAND_EMOJI_3 } from "./Quiz/brandEmoji3Data";
import { BRAND_EMOJI_3_FACTS } from "./Quiz/brandEmoji3Facts";
import { FOOD_EMOJI_3 } from "./Quiz/foodEmoji3Data";
import { FOOD_EMOJI_3_FACTS } from "./Quiz/foodEmoji3Facts";
import { HERO_EMOJI_2 } from "./Quiz/heroEmoji2Data";
import { HERO_EMOJI_2_FACTS } from "./Quiz/heroEmoji2Facts";
import { DISNEY_EMOJI_2 } from "./Quiz/disneyEmoji2Data";
import { DISNEY_EMOJI_2_FACTS } from "./Quiz/disneyEmoji2Facts";
import { ANIME_EMOJI_2 } from "./Quiz/animeEmoji2Data";
import { ANIME_EMOJI_2_FACTS } from "./Quiz/animeEmoji2Facts";
import { CARTOON_EMOJI_2 } from "./Quiz/cartoonEmoji2Data";
import { CARTOON_EMOJI_2_FACTS } from "./Quiz/cartoonEmoji2Facts";
import { MOVIE_EMOJI_4 } from "./Quiz/movieEmoji4Data";
import { MOVIE_EMOJI_4_FACTS } from "./Quiz/movieEmoji4Facts";
import { SPORTS_EMOJI_2 } from "./Quiz/sportsEmoji2Data";
import { SPORTS_EMOJI_2_FACTS } from "./Quiz/sportsEmoji2Facts";
import { LANDMARK_EMOJI } from "./Quiz/landmarkEmojiData";
import { LANDMARK_EMOJI_FACTS } from "./Quiz/landmarkEmojiFacts";
import { ANIMAL_EMOJI_2 } from "./Quiz/animalEmoji2Data";
import { ANIMAL_EMOJI_2_FACTS } from "./Quiz/animalEmoji2Facts";
import { JOBS_EMOJI_2 } from "./Quiz/jobsEmoji2Data";
...
import { ANIMAL_EMOJI_3 } from "./Quiz/animalEmoji3Data";
import { ANIMAL_EMOJI_3_FACTS } from "./Quiz/animalEmoji3Facts";
import { FOOD_EMOJI_4 } from "./Quiz/foodEmoji4Data";
import { FOOD_EMOJI_4_FACTS } from "./Quiz/foodEmoji4Facts";
import { SONG_EMOJI_4 } from "./Quiz/songEmoji4Data";
import { SONG_EMOJI_4_FACTS } from "./Quiz/songEmoji4Facts";
import { MOVIE_EMOJI_5 } from "./Quiz/movieEmoji5Data";
import { MOVIE_EMOJI_5_FACTS } from "./Quiz/movieEmoji5Facts";
import { TV_EMOJI_4 } from "./Quiz/tvEmoji4Data";
import { TV_EMOJI_4_FACTS } from "./Quiz/tvEmoji4Facts";
import { VIDEOGAME_EMOJI_4 } from "./Quiz/videogameEmoji4Data";
import { VIDEOGAME_EMOJI_4_FACTS } from "./Quiz/videogameEmoji4Facts";
import { HERO_EMOJI_3 } from "./Quiz/heroEmoji3Data";
import { HERO_EMOJI_3_FACTS } from "./Quiz/heroEmoji3Facts";
import { BRAND_EMOJI_4 } from "./Quiz/brandEmoji4Data";
import { BRAND_EMOJI_4_FACTS } from "./Quiz/brandEmoji4Facts";
import { ANIME_EMOJI_3 } from "./Quiz/animeEmoji3Data";
import { ANIME_EMOJI_3_FACTS } from "./Quiz/animeEmoji3Facts";
import { DISNEY_EMOJI_3 } from "./Quiz/disneyEmoji3Data";
import { DISNEY_EMOJI_3_FACTS } from "./Quiz/disneyEmoji3Facts";
import { CARTOON_EMOJI_3 } from "./Quiz/cartoonEmoji3Data";
import { CARTOON_EMOJI_3_FACTS } from "./Quiz/cartoonEmoji3Facts";
import { BOOK_EMOJI_4 } from "./Quiz/bookEmoji4Data";
import { BOOK_EMOJI_4_FACTS } from "./Quiz/bookEmoji4Facts";
import { LANDMARK_EMOJI_2 } from "./Quiz/landmarkEmoji2Data";
import { LANDMARK_EMOJI_2_FACTS } from "./Quiz/landmarkEmoji2Facts";
import { SPORTS_EMOJI_3 } from "./Quiz/sportsEmoji3Data";
import { SPORTS_EMOJI_3_FACTS } from "./Quiz/sportsEmoji3Facts";
import { JOBS_EMOJI_3 } from "./Quiz/jobsEmoji3Data";
import { JOBS_EMOJI_3_FACTS } from "./Quiz/jobsEmoji3Facts";
import { FRUIT_EMOJI_2 } from "./Quiz/fruitEmoji2Data";
import { FRUIT_EMOJI_2_FACTS } from "./Quiz/fruitEmoji2Facts";
import { SEACREATURE_EMOJI_2 } from "./Quiz/seacreatureEmoji2Data";
import { SEACREATURE_EMOJI_2_FACTS } from "./Quiz/seacreatureEmoji2Facts";
import { INSTRUMENT_EMOJI_2 } from "./Quiz/instrumentEmoji2Data";
import { INSTRUMENT_EMOJI_2_FACTS } from "./Quiz/instrumentEmoji2Facts";
import { VILLAIN_EMOJI_3 } from "./Quiz/villainEmoji3Data";
import { VILLAIN_EMOJI_3_FACTS } from "./Quiz/villainEmoji3Facts";
import { MYTHCREATURE_EMOJI_3 } from "./Quiz/mythcreatureEmoji3Data";
import { MYTHCREATURE_EMOJI_3_FACTS } from "./Quiz/mythcreatureEmoji3Facts";
import { WEATHER_EMOJI_2 } from "./Quiz/weatherEmoji2Data";
import { WEATHER_EMOJI_2_FACTS } from "./Quiz/weatherEmoji2Facts";
import { DESSERT_EMOJI_3 } from "./Quiz/dessertEmoji3Data";
import { DESSERT_EMOJI_3_FACTS } from "./Quiz/dessertEmoji3Facts";
import { VEHICLE_EMOJI_3 } from "./Quiz/vehicleEmoji3Data";
import { VEHICLE_EMOJI_3_FACTS } from "./Quiz/vehicleEmoji3Facts";
import { ANIMAL_EMOJI_4 } from "./Quiz/animalEmoji4Data";
import { ANIMAL_EMOJI_4_FACTS } from "./Quiz/animalEmoji4Facts";
import { FOOD_EMOJI_5 } from "./Quiz/foodEmoji5Data";
import { FOOD_EMOJI_5_FACTS } from "./Quiz/foodEmoji5Facts";
import { SONG_EMOJI_5 } from "./Quiz/songEmoji5Data";
import { SONG_EMOJI_5_FACTS } from "./Quiz/songEmoji5Facts";
import { MOVIE_EMOJI_6 } from "./Quiz/movieEmoji6Data";
import { MOVIE_EMOJI_6_FACTS } from "./Quiz/movieEmoji6Facts";
import { HOLIDAY_EMOJI_2 } from "./Quiz/holidayEmoji2Data";
import { HOLIDAY_EMOJI_2_FACTS } from "./Quiz/holidayEmoji2Facts";
import { CLOTHING_EMOJI_2 } from "./Quiz/clothingEmoji2Data";
import { CLOTHING_EMOJI_2_FACTS } from "./Quiz/clothingEmoji2Facts";
import { TOY_EMOJI_2 } from "./Quiz/toyEmoji2Data";
import { TOY_EMOJI_2_FACTS } from "./Quiz/toyEmoji2Facts";
import { CITY_EMOJI_2 } from "./Quiz/cityEmoji2Data";
import { CITY_EMOJI_2_FACTS } from "./Quiz/cityEmoji2Facts";
import { DRINK_EMOJI_2 } from "./Quiz/drinkEmoji2Data";
import { DRINK_EMOJI_2_FACTS } from "./Quiz/drinkEmoji2Facts";
import { BOARDGAME_EMOJI_2 } from "./Quiz/boardgameEmoji2Data";
import { BOARDGAME_EMOJI_2_FACTS } from "./Quiz/boardgameEmoji2Facts";
import { ANIMAL_EMOJI5 } from "./Quiz/animalEmoji5Data";
import { ANIMAL_EMOJI5_FACTS } from "./Quiz/animalEmoji5Facts";
import { MOVIE_EMOJI7 } from "./Quiz/movieEmoji7Data";
import { MOVIE_EMOJI7_FACTS } from "./Quiz/movieEmoji7Facts";
import { CARTOON_EMOJI4 } from "./Quiz/cartoonEmoji4Data";
import { CARTOON_EMOJI4_FACTS } from "./Quiz/cartoonEmoji4Facts";
import { TV_EMOJI5 } from "./Quiz/tvEmoji5Data";
import { TV_EMOJI5_FACTS } from "./Quiz/tvEmoji5Facts";
import { SONG_EMOJI6 } from "./Quiz/songEmoji6Data";
import { SONG_EMOJI6_FACTS } from "./Quiz/songEmoji6Facts";
import { BRAND_EMOJI5 } from "./Quiz/brandEmoji5Data";
import { BRAND_EMOJI5_FACTS } from "./Quiz/brandEmoji5Facts";
import { VIDEOGAME_EMOJI5 } from "./Quiz/videogameEmoji5Data";
import { VIDEOGAME_EMOJI5_FACTS } from "./Quiz/videogameEmoji5Facts";
import { BOOK_EMOJI5 } from "./Quiz/bookEmoji5Data";
import { BOOK_EMOJI5_FACTS } from "./Quiz/bookEmoji5Facts";
import { DISNEY_EMOJI4 } from "./Quiz/disneyEmoji4Data";
import { DISNEY_EMOJI4_FACTS } from "./Quiz/disneyEmoji4Facts";
import { SPORTS_EMOJI4 } from "./Quiz/sportsEmoji4Data";
import { SPORTS_EMOJI4_FACTS } from "./Quiz/sportsEmoji4Facts";
import { FOOD_EMOJI6 } from "./Quiz/foodEmoji6Data";
import { FOOD_EMOJI6_FACTS } from "./Quiz/foodEmoji6Facts";
import { ANIME_EMOJI4 } from "./Quiz/animeEmoji4Data";
import { ANIME_EMOJI4_FACTS } from "./Quiz/animeEmoji4Facts";
import { MOVIE_EMOJI8 } from "./Quiz/movieEmoji8Data";
import { MOVIE_EMOJI8_FACTS } from "./Quiz/movieEmoji8Facts";
import { TV_EMOJI6 } from "./Quiz/tvEmoji6Data";
import { TV_EMOJI6_FACTS } from "./Quiz/tvEmoji6Facts";
import { VILLAIN_EMOJI4 } from "./Quiz/villainEmoji4Data";
import { VILLAIN_EMOJI4_FACTS } from "./Quiz/villainEmoji4Facts";
import { SONG_EMOJI7 } from "./Quiz/songEmoji7Data";
import { SONG_EMOJI7_FACTS } from "./Quiz/songEmoji7Facts";
import { ANIMAL_EMOJI6 } from "./Quiz/animalEmoji6Data";
import { ANIMAL_EMOJI6_FACTS } from "./Quiz/animalEmoji6Facts";
import { BRAND_EMOJI6 } from "./Quiz/brandEmoji6Data";
import { BRAND_EMOJI6_FACTS } from "./Quiz/brandEmoji6Facts";
import { MOVIE_EMOJI9 } from "./Quiz/movieEmoji9Data";
import { MOVIE_EMOJI9_FACTS } from "./Quiz/movieEmoji9Facts";
import { VIDEOGAME_EMOJI6 } from "./Quiz/videogameEmoji6Data";
import { VIDEOGAME_EMOJI6_FACTS } from "./Quiz/videogameEmoji6Facts";
import { CARTOON_EMOJI5 } from "./Quiz/cartoonEmoji5Data";
import { CARTOON_EMOJI5_FACTS } from "./Quiz/cartoonEmoji5Facts";
import { SONG_EMOJI8 } from "./Quiz/songEmoji8Data";
import { SONG_EMOJI8_FACTS } from "./Quiz/songEmoji8Facts";
import { ANIMAL_EMOJI7 } from "./Quiz/animalEmoji7Data";
import { ANIMAL_EMOJI7_FACTS } from "./Quiz/animalEmoji7Facts";
import { MOVIE_EMOJI10 } from "./Quiz/movieEmoji10Data";
import { MOVIE_EMOJI10_FACTS } from "./Quiz/movieEmoji10Facts";
import { TV_EMOJI7 } from "./Quiz/tvEmoji7Data";
import { TV_EMOJI7_FACTS } from "./Quiz/tvEmoji7Facts";
import { FOOD_EMOJI7 } from "./Quiz/foodEmoji7Data";
import { FOOD_EMOJI7_FACTS } from "./Quiz/foodEmoji7Facts";
import { VIDEOGAME_EMOJI7 } from "./Quiz/videogameEmoji7Data";
import { VIDEOGAME_EMOJI7_FACTS } from "./Quiz/videogameEmoji7Facts";
import { ANIME_EMOJI5 } from "./Quiz/animeEmoji5Data";
import { ANIME_EMOJI5_FACTS } from "./Quiz/animeEmoji5Facts";
import { DISNEY_EMOJI5 } from "./Quiz/disneyEmoji5Data";
import { DISNEY_EMOJI5_FACTS } from "./Quiz/disneyEmoji5Facts";
...
export const RemotionRoot = () => {
  return (
    <>
      ...
      <Composition id="E159Quiz" component={QuizV2} durationInFrames={quizFrames(E159CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E159CFG }} />
      <Composition id="Thumb159" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F981", "1F987", "?", "1F30B", "1F996", "?", "1F344", "?", "1F36B"], line1: "CAN YOU NAME THE", word: "FICTIONAL PLACE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E160Quiz" component={QuizV2} durationInFrames={quizFrames(E160CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E160CFG }} />
      <Composition id="Thumb160" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F34E", "26A1", "?", "2622", "1F52D", "?", "1F4A1", "?", "1F412"], line1: "CAN YOU NAME THE", word: "SCIENTIST?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E161Quiz" component={QuizV2} durationInFrames={quizFrames(E161CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E161CFG }} />
      <Composition id="Thumb161" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["260E", "2708", "?", "1F4F7", "231A", "?", "1F680", "?", "2602"], line1: "CAN YOU NAME THE", word: "INVENTION?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E162Quiz" component={QuizV2} durationInFrames={quizFrames(E162CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E162CFG }} />
      <Composition id="Thumb162" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F431", "1F42D", "?", "1F987", "1F680", "?", "1F344", "?", "1F3B8"], line1: "CAN YOU NAME THE", word: "FAMOUS DUO?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E163Quiz" component={QuizV2} durationInFrames={quizFrames(E163CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E163CFG }} />
      <Composition id="Thumb163" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2694", "1F528", "?", "1F48D", "1F3C6", "?", "1FA84", "?", "1F531"], line1: "CAN YOU NAME THE", word: "ARTIFACT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E164Quiz" component={QuizV2} durationInFrames={quizFrames(E164CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E164CFG }} />
      <Composition id="Thumb164" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F631", "1F30C", "?", "1F35E", "1F9AA", "?", "1F33B", "?", "1F30A"], line1: "CAN YOU NAME THE", word: "PAINTING?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E165Quiz" component={QuizV2} durationInFrames={quizFrames(E165CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E165CFG }} />
      <Composition id="Thumb165" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F577", "1F3D4", "?", "1F4E6", "1F40D", "?", "1F415", "?", "1F921"], line1: "CAN YOU NAME THE", word: "PHOBIA?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E166Quiz" component={QuizV2} durationInFrames={quizFrames(E166CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E166CFG }} />
      <Composition id="Thumb166" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F42F", "1F98E", "?", "1F354", "1F430", "?", "1F406", "?", "1F986"], line1: "CAN YOU NAME THE", word: "BRAND MASCOT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E167Quiz" component={QuizV2} durationInFrames={quizFrames(E167CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E167CFG }} />
      <Composition id="Thumb167" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3B8", "1F3B9", "?", "1F3BB", "1F941", "?", "1F3BA", "?", "1F3B7"], line1: "CAN YOU NAME THE", word: "INSTRUMENT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E168Quiz" component={QuizV2} durationInFrames={quizFrames(E168CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E168CFG }} />
      <Composition id="Thumb168" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F409", "1F994", "?", "1F3AE", "1F431", "?", "1F3F9", "?", "1F406"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E169Quiz" component={QuizV2} durationInFrames={quizFrames(E169CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E169CFG }} />
      <Composition id="Thumb169" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F333", "1F577", "?", "1F94A", "2B50", "?", "1F3B2", "?", "1F3AF"], line1: "CAN YOU NAME THE", word: "GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E170Quiz" component={QuizV2} durationInFrames={quizFrames(E170CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E170CFG }} />
      <Composition id="Thumb170" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F985", "1F464", "?", "1F4AA", "1F3C3", "?", "1F9E0", "?", "23F0"], line1: "CAN YOU NAME THE", word: "SUPERPOWER?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E171Quiz" component={QuizV2} durationInFrames={quizFrames(E171CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E171CFG }} />
      <Composition id="Thumb171" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3B5", "1F3A4", "?", "1F3B8", "1F525", "?", "1F3A7", "?", "1F451"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E172Quiz" component={QuizV2} durationInFrames={quizFrames(E172CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E172CFG }} />
      <Composition id="Thumb172" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F522", "1F9B8", "?", "1F3E5", "1F47D", "?", "1F48C", "?", "1F50D"], line1: "CAN YOU NAME THE", word: "TV SHOW?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E173Quiz" component={QuizV2} durationInFrames={quizFrames(E173CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E173CFG }} />
      <Composition id="Thumb173" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["26A1", "1F981", "?", "1F36B", "1F9DB", "?", "1F3F9", "?", "1F4D3"], line1: "CAN YOU NAME THE", word: "BOOK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E174Quiz" component={QuizV2} durationInFrames={quizFrames(E174CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E174CFG }} />
      <Composition id="Thumb174" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F525", "1F98A", "?", "1F36B", "1F95C", "?", "2615", "?", "1F697"], line1: "CAN YOU NAME THE", word: "BRAND?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E175Quiz" component={QuizV2} durationInFrames={quizFrames(E175CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E175CFG }} />
      <Composition id="Thumb175" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F345", "1F963", "?", "1F9C4", "1F35E", "?", "1F353", "?", "1F382"], line1: "CAN YOU NAME THE", word: "FOOD?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E176Quiz" component={QuizV2} durationInFrames={quizFrames(E176CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E176CFG }} />
      <Composition id="Thumb176" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F41C", "1F52C", "?", "1F9BE", "26A1", "?", "1F9B8", "?", "1F3F9"], line1: "CAN YOU NAME THE", word: "SUPERHERO?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E177Quiz" component={QuizV2} durationInFrames={quizFrames(E177CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E177CFG }} />
      <Composition id="Thumb177" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F986", "2693", "?", "1F436", "1F3A9", "?", "1F415", "?", "1F417"], line1: "CAN YOU NAME THE", word: "DISNEY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E178Quiz" component={QuizV2} durationInFrames={quizFrames(E178CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E178CFG }} />
      <Composition id="Thumb178" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["26A1", "1F42D", "?", "2694", "1F47F", "?", "1F525", "?", "1F3A9"], line1: "CAN YOU NAME THE", word: "ANIME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E179Quiz" component={QuizV2} durationInFrames={quizFrames(E179CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E179CFG }} />
      <Composition id="Thumb179" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F986", "1F52B", "?", "1F415", "1F378", "?", "1F980", "?", "1F43F"], line1: "CAN YOU NAME THE", word: "CARTOON?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E180Quiz" component={QuizV2} durationInFrames={quizFrames(E180CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E180CFG }} />
      <Composition id="Thumb180" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F9CC", "1F415", "?", "1F98E", "1F427", "?", "1F42D", "?", "1F920"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E181Quiz" component={QuizV2} durationInFrames={quizFrames(E181CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E181CFG }} />
      <Composition id="Thumb181" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3C8", "1F3D1", "?", "1F6FC", "1F57A", "?", "1F9D7", "?", "1F93F"], line1: "CAN YOU NAME THE", word: "SPORT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E182Quiz" component={QuizV2} durationInFrames={quizFrames(E182CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E182CFG }} />
      <Composition id="Thumb182" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F5FC", "1F5FD", "?", "1F9F1", "1F54C", "?", "1F64F", "?", "1F355"], line1: "CAN YOU NAME THE", word: "LANDMARK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E183Quiz" component={QuizV2} durationInFrames={quizFrames(E183CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E183CFG }} />
      <Composition id="Thumb183" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F42C", "1F988", "?", "1F98B", "1F986", "?", "1F980", "?", "1F41D"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E184Quiz" component={QuizV2} durationInFrames={quizFrames(E184CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E184CFG }} />
      ...
      <Composition id="E189Quiz" component={QuizV2} durationInFrames={quizFrames(E189CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E189CFG }} />
      <Composition id="Thumb189" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F43B", "1F433", "?", "1F422", "1F9A6", "?", "1F98A", "?", "1F426"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E190Quiz" component={QuizV2} durationInFrames={quizFrames(E190CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E190CFG }} />
      <Composition id="Thumb190" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F959", "1F355", "?", "1F363", "1F35C", "?", "1F35E", "?", "1F35A"], line1: "CAN YOU NAME THE", word: "FOOD?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E191Quiz" component={QuizV2} durationInFrames={quizFrames(E191CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E191CFG }} />
      <Composition id="Thumb191" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F48D", "1F30C", "?", "2600", "1F31E", "?", "1F3A4", "?", "1F3B5"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E192Quiz" component={QuizV2} durationInFrames={quizFrames(E192CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E192CFG }} />
      <Composition id="Thumb192" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3AC", "1F37F", "?", "1F3A5", "1F981", "?", "1F6A2", "?", "1F577"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E193Quiz" component={QuizV2} durationInFrames={quizFrames(E193CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E193CFG }} />
      <Composition id="Thumb193" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F4FA", "1F3AC", "?", "1F37F", "1F451", "?", "1F9EA", "?", "1F47D"], line1: "CAN YOU NAME THE", word: "TV SHOW?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E194Quiz" component={QuizV2} durationInFrames={quizFrames(E194CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E194CFG }} />
      <Composition id="Thumb194" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3AE", "1F579", "?", "1F47E", "1F344", "?", "26CF", "?", "1F409"], line1: "CAN YOU NAME THE", word: "GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E195Quiz" component={QuizV2} durationInFrames={quizFrames(E195CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E195CFG }} />
      <Composition id="Thumb195" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F9B8", "1F987", "?", "26A1", "1F6E1", "?", "1F985", "?", "1F577"], line1: "CAN YOU NAME THE", word: "SUPERHERO?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E196Quiz" component={QuizV2} durationInFrames={quizFrames(E196CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E196CFG }} />
      <Composition id="Thumb196" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F34E", "1F354", "?", "1F6D2", "1F4F1", "?", "2615", "?", "1F45F"], line1: "CAN YOU NAME THE", word: "BRAND?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="E197Quiz" component={QuizV2} durationInFrames={quizFrames(E197CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E197CFG }} />
      <Composition id="E198Quiz" component={QuizV2} durationInFrames={quizFrames(E198CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E198CFG }} />
      <Composition id="E199Quiz" component={QuizV2} durationInFrames={quizFrames(E199CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E199CFG }} />
      <Composition id="E200Quiz" component={QuizV2} durationInFrames={quizFrames(E200CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E200CFG }} />
      <Composition id="E201Quiz" component={QuizV2} durationInFrames={quizFrames(E201CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E201CFG }} />
      <Composition id="E202Quiz" component={QuizV2} durationInFrames={quizFrames(E202CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E202CFG }} />
      <Composition id="E203Quiz" component={QuizV2} durationInFrames={quizFrames(E203CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E203CFG }} />
      <Composition id="E204Quiz" component={QuizV2} durationInFrames={quizFrames(E204CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E204CFG }} />
      <Composition id="E205Quiz" component={QuizV2} durationInFrames={quizFrames(E205CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E205CFG }} />
      <Composition id="E206Quiz" component={QuizV2} durationInFrames={quizFrames(E206CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E206CFG }} />
      <Composition id="E207Quiz" component={QuizV2} durationInFrames={quizFrames(E207CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E207CFG }} />
      <Composition id="E208Quiz" component={QuizV2} durationInFrames={quizFrames(E208CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E208CFG }} />
      <Composition id="E209Quiz" component={QuizV2} durationInFrames={quizFrames(E209CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E209CFG }} />
      <Composition id="E210Quiz" component={QuizV2} durationInFrames={quizFrames(E210CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E210CFG }} />
      <Composition id="E211Quiz" component={QuizV2} durationInFrames={quizFrames(E211CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E211CFG }} />
      <Composition id="E212Quiz" component={QuizV2} durationInFrames={quizFrames(E212CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E212CFG }} />
      <Composition id="E213Quiz" component={QuizV2} durationInFrames={quizFrames(E213CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E213CFG }} />
      <Composition id="E214Quiz" component={QuizV2} durationInFrames={quizFrames(E214CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E214CFG }} />
      <Composition id="E215Quiz" component={QuizV2} durationInFrames={quizFrames(E215CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E215CFG }} />
      <Composition id="E216Quiz" component={QuizV2} durationInFrames={quizFrames(E216CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E216CFG }} />
      <Composition id="E217Quiz" component={QuizV2} durationInFrames={quizFrames(E217CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E217CFG }} />
      <Composition id="E218Quiz" component={QuizV2} durationInFrames={quizFrames(E218CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E218CFG }} />
      <Composition id="E219Quiz" component={QuizV2} durationInFrames={quizFrames(E219CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E219CFG }} />
      <Composition id="E220Quiz" component={QuizV2} durationInFrames={quizFrames(E220CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E220CFG }} />
      <Composition id="E221Quiz" component={QuizV2} durationInFrames={quizFrames(E221CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E221CFG }} />
      <Composition id="E222Quiz" component={QuizV2} durationInFrames={quizFrames(E222CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E222CFG }} />
      <Composition id="E223Quiz" component={QuizV2} durationInFrames={quizFrames(E223CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E223CFG }} />
      <Composition id="E224Quiz" component={QuizV2} durationInFrames={quizFrames(E224CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E224CFG }} />
      <Composition id="E225Quiz" component={QuizV2} durationInFrames={quizFrames(E225CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E225CFG }} />
      <Composition id="E226Quiz" component={QuizV2} durationInFrames={quizFrames(E226CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E226CFG }} />
      <Composition id="E227Quiz" component={QuizV2} durationInFrames={quizFrames(E227CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E227CFG }} />
      <Composition id="E228Quiz" component={QuizV2} durationInFrames={quizFrames(E228CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E228CFG }} />
      <Composition id="E229Quiz" component={QuizV2} durationInFrames={quizFrames(E229CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E229CFG }} />
      <Composition id="E230Quiz" component={QuizV2} durationInFrames={quizFrames(E230CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E230CFG }} />
      <Composition id="E231Quiz" component={QuizV2} durationInFrames={quizFrames(E231CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E231CFG }} />
      <Composition id="E232Quiz" component={QuizV2} durationInFrames={quizFrames(E232CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E232CFG }} />
      <Composition id="E233Quiz" component={QuizV2} durationInFrames={quizFrames(E233CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E233CFG }} />
      <Composition id="E234Quiz" component={QuizV2} durationInFrames={quizFrames(E234CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E234CFG }} />
      <Composition id="E235Quiz" component={QuizV2} durationInFrames={quizFrames(E235CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E235CFG }} />
      <Composition id="E236Quiz" component={QuizV2} durationInFrames={quizFrames(E236CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E236CFG }} />
      <Composition id="E237Quiz" component={QuizV2} durationInFrames={quizFrames(E237CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E237CFG }} />
      <Composition id="E238Quiz" component={QuizV2} durationInFrames={quizFrames(E238CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E238CFG }} />
      <Composition id="E239Quiz" component={QuizV2} durationInFrames={quizFrames(E239CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E239CFG }} />
      <Composition id="E240Quiz" component={QuizV2} durationInFrames={quizFrames(E240CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E240CFG }} />
      <Composition id="E241Quiz" component={QuizV2} durationInFrames={quizFrames(E241CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E241CFG }} />
      <Composition id="E242Quiz" component={QuizV2} durationInFrames={quizFrames(E242CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E242CFG }} />
      <Composition id="E243Quiz" component={QuizV2} durationInFrames={quizFrames(E243CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E243CFG }} />
      <Composition id="E244Quiz" component={QuizV2} durationInFrames={quizFrames(E244CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E244CFG }} />
      <Composition id="E245Quiz" component={QuizV2} durationInFrames={quizFrames(E245CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E245CFG }} />
      <Composition id="E246Quiz" component={QuizV2} durationInFrames={quizFrames(E246CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E246CFG }} />
      <Composition id="E247Quiz" component={QuizV2} durationInFrames={quizFrames(E247CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E247CFG }} />
      <Composition id="E248Quiz" component={QuizV2} durationInFrames={quizFrames(E248CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E248CFG }} />
      <Composition id="E249Quiz" component={QuizV2} durationInFrames={quizFrames(E249CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E249CFG }} />
      <Composition id="E250Quiz" component={QuizV2} durationInFrames={quizFrames(E250CFG)} fps={30} width={1920} height={1080} defaultProps={{ config: E250CFG }} />
      <Composition id="Thumb197" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F977", "1F409", "?", "2694", "1F338", "?", "1F47A", "?", "1F365"], line1: "CAN YOU NAME THE", word: "ANIME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb198" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3F0", "1F42D", "1F478", "1F981", "1F9DC", "2728", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "DISNEY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb199" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F9FD", "1F4FA", "1F430", "1F369", "2B50", "1F3A8", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "CARTOON?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb200" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F4DA", "1F4D6", "270D", "1F40B", "26A1", "1F577", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "BOOK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb201" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F5FC", "1F5FD", "1F3F0", "1F54C", "26E9", "1F309", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "LANDMARK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb202" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["26BD", "1F3C0", "1F3BE", "1F3C8", "26BE", "1F3D3", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SPORT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb203" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1FA7A", "1F527", "1F3A8", "1F692", "1F33E", "1F4F7", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "JOB?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb204" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F34E", "1F34C", "1F347", "1F955", "1F353", "1F951", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "FRUIT OR VEG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb205" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F42C", "1F988", "1F419", "1F420", "1F980", "1F433", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SEA CREATURE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb206" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3B8", "1F3B9", "1F941", "1F3BB", "1F3BA", "1FA95", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "INSTRUMENT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb207" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F608", "1F480", "1F9B9", "1F47A", "1F52A", "1F451", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "VILLAIN?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb208" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F409", "1F984", "1F9DC", "1F9DA", "1F479", "1F525", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MYTHICAL CREATURE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb209" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F327", "26C8", "1F32A", "1F308", "2744", "1F30A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "WEATHER?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb210" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F370", "1F369", "1F9C1", "1F36A", "1F36B", "1F36E", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "DESSERT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb211" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F697", "1F680", "1F682", "1F3CD", "1F681", "1F6A4", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "VEHICLE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb212" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F981", "1F418", "1F42C", "1F992", "1F427", "1F98A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb213" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F355", "1F32E", "1F35C", "1F363", "1F958", "1F354", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "FOOD?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb214" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3B5", "1F3A7", "1F3A4", "1F3B8", "1F3B9", "1F3B6", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb215" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3AC", "1F37F", "1F3A5", "1F981", "1F6A2", "1F577", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb216" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F384", "1F383", "1F386", "1F387", "1F388", "1F38A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "HOLIDAY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb217" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F455", "1F456", "1F9E5", "1F457", "1F45E", "1F9E2", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "CLOTHING?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb218" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F9F8", "1FA80", "1F388", "1FA81", "1F38E", "1F9E9", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "TOY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb219" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F5FD", "1F5FC", "1F3F0", "1F309", "1F54C", "26E9", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "CITY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb220" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2615", "1F375", "1F964", "1F9C3", "1F37A", "1F95B", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "DRINK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb221" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3B2", "265F", "1F3AF", "1F0CF", "1F004", "1F9E9", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "BOARD GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb222" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F42D", "1F994", "1F427", "1F985", "1F989", "1F409", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb223" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F380", "1F9F9", "1F4A3", "1FA90", "1F431", "2708", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb224" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F369", "1F431", "1F42D", "1F37A", "1F414", "2744", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "CARTOON?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb225" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F511", "1F3A9", "1F3EB", "1F48A", "1F5E1", "1F4FC", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "TV SHOW?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb226" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F48D", "1F525", "1F4DE", "1F494", "1F389", "1F5FD", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb227" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F4FA", "1F3AE", "1F697", "1F5FB", "1F95C", "1F36B", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "BRAND?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb228" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3AE", "1F579", "1F3C6", "1F525", "1F47E", "1F3C1", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb229" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F4DA", "1F4D6", "270D", "1F50D", "1F451", "1F409", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "BOOK?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb230" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3F0", "1F42D", "1F451", "2728", "1F9DE", "1F981", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "DISNEY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb231" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["26BD", "1F3C0", "1F3BE", "1F3C8", "26BE", "1F3D3", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SPORT?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb232" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F355", "1F32E", "1F35C", "1F363", "1F958", "1F354", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "FOOD?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb233" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F977", "1F409", "2694", "1F338", "1F47A", "1F365", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb234" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F334", "1F47D", "2694", "1F409", "1F3F9", "26A1", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb235" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["1F3A4", "1F3C6", "1F988", "1F4B0", "1F483", "2B50", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "TV SHOW?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb236" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "VILLAIN?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb237" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb238" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb239" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "BRAND?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb240" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb241" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb242" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "CARTOON?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb243" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "SONG?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb244" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIMAL?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb245" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "MOVIE?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb246" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "TV SHOW?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb247" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "FOOD?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb248" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "GAME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb249" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "ANIME?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      <Composition id="Thumb250" component={GsThumbV2} durationInFrames={1} fps={30} width={1280} height={720} defaultProps={{ mode: "emoji", grid: ["2744", "1F480", "1F441", "1F525", "1F34E", "1F52A", "?", "?", "?"], line1: "CAN YOU NAME THE", word: "DISNEY?", number: "100", year: "2026", badge: "Only 1% get 100%" }} />
      ...
      {[
        ...
        { ep: "E159", items: PLACE_EMOJI, mode: "eplace", title: "Guess the Fictional Place by Emoji", v2: true, theme: 6 },
        { ep: "E160", items: SCIENTIST_EMOJI, mode: "escientist", title: "Guess the Scientist by Emoji", v2: true, theme: 6 },
        { ep: "E161", items: INVENTION_EMOJI, mode: "einvention", title: "Guess the Invention by Emoji", v2: true, theme: 6 },
        { ep: "E162", items: DUO_EMOJI, mode: "eduo", title: "Guess the Famous Duo by Emoji", v2: true, theme: 6 },
        { ep: "E163", items: ARTIFACT_EMOJI, mode: "eartifact", title: "Guess the Legendary Weapon or Artifact by Emoji", v2: true, theme: 6 },
        { ep: "E164", items: PAINTING_EMOJI, mode: "epainting", title: "Guess the Famous Painting by Emoji", v2: true, theme: 6 },
        { ep: "E165", items: PHOBIA_EMOJI, mode: "ephobia", title: "Guess the Phobia by Emoji", v2: true, theme: 6 },
        { ep: "E166", items: MASCOT_EMOJI, mode: "emascot", title: "Guess the Brand Mascot by Emoji", v2: true, theme: 6 },
        { ep: "E167", items: INSTRUMENT_EMOJI, mode: "einstrument", title: "Guess the Musical Instrument by Emoji", v2: true, theme: 6 },
        { ep: "E168", items: MOVIE_EMOJI_3, mode: "emovie3", title: "Guess the Movie by Emoji 3", v2: true, theme: 6 },
        { ep: "E169", items: VIDEOGAME_EMOJI_3, mode: "egame3", title: "Guess the Video Game by Emoji 3", v2: true, theme: 6 },
        { ep: "E170", items: SUPERPOWER_EMOJI, mode: "epower", title: "Guess the Superpower by Emoji", v2: true, theme: 6 },
        { ep: "E171", items: SONG_EMOJI_3, mode: "esong3", title: "Guess the Song by Emoji 3", v2: true, theme: 6 },
        { ep: "E172", items: TV_EMOJI_3, mode: "etv3", title: "Guess the TV Show by Emoji 3", v2: true, theme: 6 },
        { ep: "E173", items: BOOK_EMOJI_3, mode: "ebook3", title: "Guess the Book by Emoji 3", v2: true, theme: 6 },
        { ep: "E174", items: BRAND_EMOJI_3, mode: "ebrand3", title: "Guess the Brand by Emoji 3", v2: true, theme: 6 },
        { ep: "E175", items: FOOD_EMOJI_3, mode: "efood3", title: "Guess the Food by Emoji 3", v2: true, theme: 6 },
        { ep: "E176", items: HERO_EMOJI_2, mode: "eheroes2", title: "Guess the Superhero by Emoji 2", v2: true, theme: 6 },
        { ep: "E177", items: DISNEY_EMOJI_2, mode: "edisney2", title: "Guess the Disney Character by Emoji 2", v2: true, theme: 6 },
        { ep: "E178", items: ANIME_EMOJI_2, mode: "eanime2", title: "Guess the Anime by Emoji 2", v2: true, theme: 6 },
        { ep: "E179", items: CARTOON_EMOJI_2, mode: "ecartoon2", title: "Guess the Cartoon Character by Emoji 2", v2: true, theme: 6 },
        { ep: "E180", items: MOVIE_EMOJI_4, mode: "emovie4", title: "Guess the Movie by Emoji 4", v2: true, theme: 6 },
        { ep: "E181", items: SPORTS_EMOJI_2, mode: "esports2", title: "Guess the Sport by Emoji 2", v2: true, theme: 6 },
        { ep: "E182", items: LANDMARK_EMOJI, mode: "elandmark", title: "Guess the Landmark by Emoji", v2: true, theme: 6 },
        ...
        { ep: "E189", items: ANIMAL_EMOJI_3, mode: "eanimal3", title: "Guess the Animal by Emoji 3", v2: true, theme: 6 },
        { ep: "E190", items: FOOD_EMOJI_4, mode: "efood4", title: "Guess the Food by Emoji 4", v2: true, theme: 6 },
        { ep: "E191", items: SONG_EMOJI_4, mode: "esong4", title: "Guess the Song by Emoji 4", v2: true, theme: 6 },
        { ep: "E192", items: MOVIE_EMOJI_5, mode: "emovie5", title: "Guess the Movie by Emoji 5", v2: true, theme: 6 },
        { ep: "E193", items: TV_EMOJI_4, mode: "etv4", title: "Guess the TV Show by Emoji 4", v2: true, theme: 6 },
        { ep: "E194", items: VIDEOGAME_EMOJI_4, mode: "egame4", title: "Guess the Game by Emoji 4", v2: true, theme: 6 },
        { ep: "E195", items: HERO_EMOJI_3, mode: "eheroes3", title: "Guess the Superhero by Emoji 3", v2: true, theme: 6 },
        { ep: "E196", items: BRAND_EMOJI_4, mode: "ebrand4", title: "Guess the Brand by Emoji 4", v2: true, theme: 6 },
        { ep: "E197", items: ANIME_EMOJI_3, mode: "eanime3", title: "Guess the Anime by Emoji 3", v2: true, theme: 6 },
        { ep: "E198", items: DISNEY_EMOJI_3, mode: "edisney3", title: "Guess the Disney Character by Emoji 3", v2: true, theme: 6 },
        { ep: "E199", items: CARTOON_EMOJI_3, mode: "ecartoon3", title: "Guess the Cartoon Character by Emoji 3", v2: true, theme: 6 },
        { ep: "E200", items: BOOK_EMOJI_4, mode: "ebook4", title: "Guess the Book by Emoji 4", v2: true, theme: 6 },
        { ep: "E201", items: LANDMARK_EMOJI_2, mode: "elandmark2", title: "Guess the Landmark by Emoji 2", v2: true, theme: 6 },
        { ep: "E202", items: SPORTS_EMOJI_3, mode: "esport3", title: "Guess the Sport by Emoji 3", v2: true, theme: 6 },
        { ep: "E203", items: JOBS_EMOJI_3, mode: "ejobs3", title: "Guess the Job by Emoji 3", v2: true, theme: 6 },
        { ep: "E204", items: FRUIT_EMOJI_2, mode: "efruit2", title: "Guess the Fruit or Veg by Emoji 2", v2: true, theme: 6 },
        { ep: "E205", items: SEACREATURE_EMOJI_2, mode: "eseacreature2", title: "Guess the Sea Creature by Emoji 2", v2: true, theme: 6 },
        { ep: "E206", items: INSTRUMENT_EMOJI_2, mode: "einstrument2", title: "Guess the Instrument by Emoji 2", v2: true, theme: 6 },
        { ep: "E207", items: VILLAIN_EMOJI_3, mode: "evillain3", title: "Guess the Villain by Emoji 3", v2: true, theme: 6 },
        { ep: "E208", items: MYTHCREATURE_EMOJI_3, mode: "emythcreature3", title: "Guess the Mythical Creature by Emoji 3", v2: true, theme: 6 },
        { ep: "E209", items: WEATHER_EMOJI_2, mode: "eweather2", title: "Guess the Weather by Emoji 2", v2: true, theme: 6 },
        { ep: "E210", items: DESSERT_EMOJI_3, mode: "edessert3", title: "Guess the Dessert by Emoji 3", v2: true, theme: 6 },
        { ep: "E211", items: VEHICLE_EMOJI_3, mode: "evehicle3", title: "Guess the Vehicle by Emoji 3", v2: true, theme: 6 },
        { ep: "E212", items: ANIMAL_EMOJI_4, mode: "eanimal4", title: "Guess the Animal by Emoji 4", v2: true, theme: 6 },
        { ep: "E213", items: FOOD_EMOJI_5, mode: "efood5", title: "Guess the Food by Emoji 5", v2: true, theme: 6 },
        { ep: "E214", items: SONG_EMOJI_5, mode: "esong5", title: "Guess the Song by Emoji 5", v2: true, theme: 6 },
        { ep: "E215", items: MOVIE_EMOJI_6, mode: "emovie6", title: "Guess the Movie by Emoji 6", v2: true, theme: 6 },
        { ep: "E216", items: HOLIDAY_EMOJI_2, mode: "eholiday2", title: "Guess the Holiday by Emoji 2", v2: true, theme: 6 },
        { ep: "E217", items: CLOTHING_EMOJI_2, mode: "eclothing2", title: "Guess the Clothing by Emoji 2", v2: true, theme: 6 },
        { ep: "E218", items: TOY_EMOJI_2, mode: "etoy2", title: "Guess the Toy by Emoji 2", v2: true, theme: 6 },
        { ep: "E219", items: CITY_EMOJI_2, mode: "ecity2", title: "Guess the City by Emoji 2", v2: true, theme: 6 },
        { ep: "E220", items: DRINK_EMOJI_2, mode: "edrink2", title: "Guess the Drink by Emoji 2", v2: true, theme: 6 },
        { ep: "E221", items: BOARDGAME_EMOJI_2, mode: "eboardgame2", title: "Guess the Board Game by Emoji 2", v2: true, theme: 6 },
        { ep: "E222", items: ANIMAL_EMOJI5, mode: "eanimal5", title: "Guess the Animal by Emoji 5", v2: true, theme: 6 },
        { ep: "E223", items: MOVIE_EMOJI7, mode: "emovie7", title: "Guess the Movie by Emoji 7", v2: true, theme: 6 },
        { ep: "E224", items: CARTOON_EMOJI4, mode: "ecartoon4", title: "Guess the Cartoon by Emoji 4", v2: true, theme: 6 },
        { ep: "E225", items: TV_EMOJI5, mode: "etv5", title: "Guess the TV Show by Emoji 5", v2: true, theme: 6 },
        { ep: "E226", items: SONG_EMOJI6, mode: "esong6", title: "Guess the Song by Emoji 6", v2: true, theme: 6 },
        { ep: "E227", items: BRAND_EMOJI5, mode: "ebrand5", title: "Guess the Brand by Emoji 5", v2: true, theme: 6 },
        { ep: "E228", items: VIDEOGAME_EMOJI5, mode: "evideogame5", title: "Guess the Video Game by Emoji 5", v2: true, theme: 6 },
        { ep: "E229", items: BOOK_EMOJI5, mode: "ebook5", title: "Guess the Book by Emoji 5", v2: true, theme: 6 },
        { ep: "E230", items: DISNEY_EMOJI4, mode: "edisney4", title: "Guess the Disney Character by Emoji 4", v2: true, theme: 6 },
        { ep: "E231", items: SPORTS_EMOJI4, mode: "esport4", title: "Guess the Sport by Emoji 4", v2: true, theme: 6 },
        { ep: "E232", items: FOOD_EMOJI6, mode: "efood6", title: "Guess the Food by Emoji 6", v2: true, theme: 6 },
        { ep: "E233", items: ANIME_EMOJI4, mode: "eanime4", title: "Guess the Anime by Emoji 4", v2: true, theme: 6 },
        { ep: "E234", items: MOVIE_EMOJI8, mode: "emovie8", title: "Guess the Movie by Emoji 8", v2: true, theme: 6 },
        { ep: "E235", items: TV_EMOJI6, mode: "etv6", title: "Guess the TV Show by Emoji 6", v2: true, theme: 6 },
        { ep: "E236", items: VILLAIN_EMOJI4, mode: "evillain4", title: "Guess the Villain by Emoji 4", v2: true, theme: 6 },
        { ep: "E237", items: SONG_EMOJI7, mode: "esong7", title: "Guess the Song by Emoji 7", v2: true, theme: 6 },
        { ep: "E238", items: ANIMAL_EMOJI6, mode: "eanimal6", title: "Guess the Animal by Emoji 6", v2: true, theme: 6 },
        { ep: "E239", items: BRAND_EMOJI6, mode: "ebrand6", title: "Guess the Brand by Emoji 6", v2: true, theme: 6 },
        { ep: "E240", items: MOVIE_EMOJI9, mode: "emovie9", title: "Guess the Movie by Emoji 9", v2: true, theme: 6 },
        { ep: "E241", items: VIDEOGAME_EMOJI6, mode: "evideogame6", title: "Guess the Video Game by Emoji 6", v2: true, theme: 6 },
        { ep: "E242", items: CARTOON_EMOJI5, mode: "ecartoon5", title: "Guess the Cartoon by Emoji 5", v2: true, theme: 6 },
        { ep: "E243", items: SONG_EMOJI8, mode: "esong8", title: "Guess the Song by Emoji 8", v2: true, theme: 6 },
        { ep: "E244", items: ANIMAL_EMOJI7, mode: "eanimal7", title: "Guess the Animal by Emoji 7", v2: true, theme: 6 },
        { ep: "E245", items: MOVIE_EMOJI10, mode: "emovie10", title: "Guess the Movie by Emoji 10", v2: true, theme: 6 },
        { ep: "E246", items: TV_EMOJI7, mode: "etv7", title: "Guess the TV Show by Emoji 7", v2: true, theme: 6 },
        { ep: "E247", items: FOOD_EMOJI7, mode: "efood7", title: "Guess the Food by Emoji 7", v2: true, theme: 6 },
        { ep: "E248", items: VIDEOGAME_EMOJI7, mode: "evideogame7", title: "Guess the Video Game by Emoji 7", v2: true, theme: 6 },
        { ep: "E249", items: ANIME_EMOJI5, mode: "eanime5", title: "Guess the Anime by Emoji 5", v2: true, theme: 6 },
        { ep: "E250", items: DISNEY_EMOJI5, mode: "edisney5", title: "Guess the Disney Character by Emoji 5", v2: true, theme: 6 },
