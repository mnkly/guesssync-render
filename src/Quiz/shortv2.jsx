...
const Clue = ({ item, mode, revealed, accent, zoom }) => {
  ...
  // below is untouched.
  if (mode === "scrambled" || mode === "novowels" || mode === "reversed" || mode === "capitalscrambled") {
    const text = mode === "novowels" ? item.novowels : mode === "reversed" ? item.reversed : item.scrambled;
