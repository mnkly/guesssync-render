...
const ABCD = ["A", "B", "C", "D"];
const nameOf = (x, mode) => mode === "emojiword" ? x.answer : (mode === "paintings" || mode === "movies" || mode === "efoods" || mode === "esongs" || mode === "egames" || mode === "ecountries" || mode === "ecountries2" || mode === "etv" || mode === "ebrands" || mode === "ebooks" || mode === "esongs2" || mode === "movies2" || mode === "egames2" || mode === "etv2" || mode === "ebooks2" || mode === "ebrands2" || mode === "efoods2" || mode === "eheroes" || mode === "edisney" || mode === "eanime" || mode === "eanimal" || mode === "esports" || mode === "ejobs" || mode === "ecartoon" || mode === "efairytale" || mode === "eband" || mode === "efruit" || mode === "eboardgame" || mode === "evehicle" || mode === "eholiday" || mode === "emythcreature" || mode === "eweather" || mode === "eancientgod" || mode === "ehobby" || mode === "ecity" || mode === "edance" || mode === "eseacreature" || mode === "eclothing" || mode === "edrink" || mode === "egamechar" || mode === "evillain" || mode === "etoy" || mode === "eanimechar" || mode === "erhyme" || mode === "edessert" || mode === "eplace" || mode === "escientist" || mode === "einvention" || mode === "eduo" || mode === "eartifact" || mode === "epainting" || mode === "ephobia" || mode === "emascot" || mode === "einstrument" || mode === "emovie3" || mode === "egame3" || mode === "epower" || mode === "esong3" || mode === "etv3" || mode === "ebook3" || mode === "ebrand3" || mode === "efood3" || mode === "eheroes2" || mode === "edisney2" || mode === "eanime2" || mode === "ecartoon2" || mode === "emovie4" || mode === "esports2" || mode === "elandmark" || mode === "eanimal2" || mode === "ejobs2" || mode === "emythcreature2" || mode === "edessert2" || mode === "evehicle2" || mode === "evillain2" || mode === "eanimal3" || mode === "efood4" || mode === "esong4" || mode === "emovie5" || mode === "etv4" || mode === "egame4" || mode === "eheroes3" || mode === "ebrand4" || mode === "eanime3" || mode === "edisney3" || mode === "ecartoon3" || mode === "ebook4" || mode === "elandmark2" || mode === "esport3" || mode === "ejobs3" || mode === "efruit2" || mode === "eseacreature2" || mode === "einstrument2" || mode === "evillain3" || mode === "emythcreature3" || mode === "eweather2" || mode === "edessert3" || mode === "evehicle3" || mode === "eanimal4" || mode === "efood5" || mode === "esong5" || mode === "emovie6" || mode === "eholiday2" || mode === "eclothing2" || mode === "etoy2" || mode === "ecity2" || mode === "edrink2" || mode === "eboardgame2" || mode === "eanimal5" || mode === "emovie7" || mode === "ecartoon4" || mode === "etv5" || mode === "esong6" || mode === "ebrand5" || mode === "evideogame5" || mode === "ebook5" || mode === "edisney4" || mode === "esport4" || mode === "efood6" || mode === "eanime4" || mode === "emovie8" || mode === "etv6" || mode === "evillain4" || mode === "esong7" || mode === "eanimal6" || mode === "ebrand6" || mode === "emovie9" || mode === "evideogame6" || mode === "ecartoon5" || mode === "esong8" || mode === "eanimal7" || mode === "emovie10") ? x.title : mode === "capitals" ? x.capital : (x.name || x.country || x.slug);
...
const Clue = ({ item, mode, revealed, accent, zoom }) => {
  ...
  if (mode === "movies" || mode === "efoods" || mode === "esongs" || mode === "egames" || mode === "ecountries" || mode === "ecountries2" || mode === "etv" || mode === "ebrands" || mode === "ebooks" || mode === "esongs2" || mode === "movies2" || mode === "egames2" || mode === "etv2" || mode === "ebooks2" || mode === "ebrands2" || mode === "efoods2" || mode === "eheroes" || mode === "edisney" || mode === "eanime" || mode === "eanimal" || mode === "esports" || mode === "ejobs" || mode === "ecartoon" || mode === "efairytale" || mode === "eband" || mode === "efruit" || mode === "eboardgame" || mode === "evehicle" || mode === "eholiday" || mode === "emythcreature" || mode === "eweather" || mode === "eancientgod" || mode === "ehobby" || mode === "ecity" || mode === "edance" || mode === "eseacreature" || mode === "eclothing" || mode === "edrink" || mode === "egamechar" || mode === "evillain" || mode === "etoy" || mode === "eanimechar" || mode === "erhyme" || mode === "edessert" || mode === "eplace" || mode === "escientist" || mode === "einvention" || mode === "eduo" || mode === "eartifact" || mode === "epainting" || mode === "ephobia" || mode === "emascot" || mode === "einstrument" || mode === "emovie3" || mode === "egame3" || mode === "epower" || mode === "esong3" || mode === "etv3" || mode === "ebook3" || mode === "ebrand3" || mode === "efood3" || mode === "eheroes2" || mode === "edisney2" || mode === "eanime2" || mode === "ecartoon2" || mode === "emovie4" || mode === "esports2" || mode === "elandmark" || mode === "eanimal2" || mode === "ejobs2" || mode === "emythcreature2" || mode === "edessert2" || mode === "evehicle2" || mode === "evillain2" || mode === "eanimal3" || mode === "efood4" || mode === "esong4" || mode === "emovie5" || mode === "etv4" || mode === "egame4" || mode === "eheroes3" || mode === "ebrand4" || mode === "eanime3" || mode === "edisney3" || mode === "ecartoon3" || mode === "ebook4" || mode === "elandmark2" || mode === "esport3" || mode === "ejobs3" || mode === "efruit2" || mode === "eseacreature2" || mode === "einstrument2" || mode === "evillain3" || mode === "emythcreature3" || mode === "eweather2" || mode === "edessert3" || mode === "evehicle3" || mode === "eanimal4" || mode === "efood5" || mode === "esong5" || mode === "emovie6" || mode === "eholiday2" || mode === "eclothing2" || mode === "etoy2" || mode === "ecity2" || mode === "edrink2" || mode === "eboardgame2" || mode === "eanimal5" || mode === "emovie7" || mode === "ecartoon4" || mode === "etv5" || mode === "esong6" || mode === "ebrand5" || mode === "evideogame5" || mode === "ebook5" || mode === "edisney4" || mode === "esport4" || mode === "efood6" || mode === "eanime4" || mode === "emovie8" || mode === "etv6" || mode === "evillain4" || mode === "esong7" || mode === "eanimal6" || mode === "ebrand6" || mode === "emovie9" || mode === "evideogame6" || mode === "ecartoon5" || mode === "esong8" || mode === "eanimal7" || mode === "emovie10") { const chars = [...item.emojis]; const sz = chars.length <= 2 ? 280 : chars.length === 3 ? 220 : 170; return <div style={{ ...card, width: 640, height: 640, display: "flex", flexWrap: "wrap", gap: 20, alignItems: "center", justifyContent: "center", padding: 36 }}>{chars.map((ch, i) => <Img key={i} src={staticFile(`openmoji/${[...ch].map((c) => c.codePointAt(0).toString(16).toUpperCase()).join("-")}.svg`)} style={{ width: sz, height: sz, objectFit: "contain" }} />)}</div>; }
...
const QWORD = { movies: "GUESS THE MOVIE", efoods: "GUESS THE FOOD", esongs: "GUESS THE SONG", egames: "GUESS THE GAME", ecountries: "GUESS THE COUNTRY", ecountries2: "GUESS THE COUNTRY", etv: "GUESS THE TV SHOW", ebrands: "GUESS THE BRAND", ebooks: "GUESS THE BOOK", gaming: "GUESS THE GAME", airlines: "GUESS THE AIRLINE", fastfood: "GUESS THE FAST FOOD", fish: "GUESS THE FISH", fish2: "GUESS THE FISH", cocktails: "GUESS THE COCKTAIL", drinks: "GUESS THE DRINK", breads: "GUESS THE BREAD", nuts: "GUESS THE NUT OR SEED", cacti: "GUESS THE CACTUS OR SUCCULENT", desserts: "GUESS THE DESSERT", kitchen: "GUESS THE KITCHEN UTENSIL", spices: "GUESS THE HERB OR SPICE", pasta: "GUESS THE PASTA", cheese: "GUESS THE CHEESE", trains: "GUESS THE TRAIN", primates: "GUESS THE PRIMATE", boats: "GUESS THE BOAT", shells: "GUESS THE SEASHELL", mushrooms: "GUESS THE MUSHROOM", mushrooms2: "GUESS THE MUSHROOM", aircraft: "GUESS THE AIRCRAFT", space: "GUESS THE SPACE OBJECT", sports: "GUESS THE SPORT", trees: "GUESS THE TREE", tools: "GUESS THE TOOL", rocks: "GUESS THE ROCK", hats: "GUESS THE HAT", reptiles: "GUESS THE REPTILE", reptiles2: "GUESS THE REPTILE", silhouette: "GUESS THE ANIMAL", dinosilhouette: "GUESS THE DINOSAUR", animals2: "GUESS THE ANIMAL", animals3: "GUESS THE ANIMAL", landmarks2: "GUESS THE LANDMARK", spiders: "GUESS THE SPIDER", amphibians: "GUESS THE AMPHIBIAN", horses: "GUESS THE HORSE BREED", gems: "GUESS THE GEMSTONE", insects: "GUESS THE INSECT", insects2: "GUESS THE INSECT", cats: "GUESS THE CAT BREED", carlogos: "GUESS THE CAR", logos: "GUESS THE LOGO", natteams: "GUESS THE TEAM", coatofarms: "GUESS THE COUNTRY", clubs: "GUESS THE CLUB", clubbadges: "GUESS THE FOOTBALL CLUB", animals: "GUESS THE ANIMAL", foods: "GUESS THE FOOD", foods2: "GUESS THE DISH", dogs: "GUESS THE DOG BREED", dogs2: "GUESS THE DOG BREED", cars: "GUESS THE CAR", cars2: "GUESS THE CAR", birds: "GUESS THE BIRD", birds2: "GUESS THE BIRD", sea: "GUESS THE SEA CREATURE", sea2: "GUESS THE SEA CREATURE", fruits: "FRUIT OR VEG?", flowers: "GUESS THE FLOWER", flowers2: "GUESS THE FLOWER", butterflies: "GUESS THE BUTTERFLY", butterflies2: "GUESS THE BUTTERFLY", snakes: "GUESS THE SNAKE", dinos: "GUESS THE DINOSAUR", paintings: "GUESS THE PAINTING", landmarks: "WHICH COUNTRY?", landmarkzoom: "GUESS THE LANDMARK", foodzoom: "GUESS THE FOOD", flags: "GUESS THE COUNTRY", flagsmega: "GUESS THE FLAG", flagzoom: "GUESS THE ZOOMED FLAG", capitals: "GUESS THE CAPITAL", countries: "WHICH COUNTRY?", shapes: "WHAT COUNTRY?", countryshapes: "GUESS THE COUNTRY", countrymap: "WHICH COUNTRY?", usstates: "WHICH STATE?", instruments: "GUESS THE INSTRUMENT", scrambled: "GUESS THE COUNTRY", novowels: "GUESS THE COUNTRY", reversed: "GUESS THE COUNTRY", capitalscrambled: "GUESS THE CAPITAL", usstatescrambled: "WHICH STATE?", missingletters: "GUESS THE COUNTRY", emojiword: "GUESS THE WORD", slogan: "GUESS THE BRAND", esongs2: "GUESS THE SONG", movies2: "GUESS THE MOVIE", egames2: "GUESS THE GAME", etv2: "GUESS THE TV SHOW", ebooks2: "GUESS THE BOOK", ebrands2: "GUESS THE BRAND", efoods2: "GUESS THE FOOD", eheroes: "GUESS THE SUPERHERO", edisney: "GUESS THE DISNEY", eanime: "GUESS THE ANIME", eanimal: "GUESS THE ANIMAL", esports: "GUESS THE SPORT", ejobs: "GUESS THE JOB", ecartoon: "GUESS THE CARTOON", efairytale: "GUESS THE FAIRY TALE", eband: "GUESS THE BAND", efruit: "GUESS THE FRUIT", eboardgame: "GUESS THE BOARD GAME", evehicle: "GUESS THE VEHICLE", eholiday: "GUESS THE HOLIDAY", emythcreature: "GUESS THE MYTHICAL CREATURE", eweather: "GUESS THE WEATHER", eancientgod: "GUESS THE ANCIENT GOD", ehobby: "GUESS THE HOBBY", ecity: "GUESS THE CITY", edance: "GUESS THE DANCE", eseacreature: "GUESS THE SEA CREATURE", eclothing: "GUESS THE CLOTHING", edrink: "GUESS THE DRINK", egamechar: "GUESS THE GAME CHARACTER", evillain: "GUESS THE VILLAIN", etoy: "GUESS THE TOY", eanimechar: "GUESS THE ANIME CHARACTER", erhyme: "GUESS THE NURSERY RHYME", edessert: "GUESS THE DESSERT", eplace: "GUESS THE FICTIONAL PLACE", escientist: "GUESS THE SCIENTIST", einvention: "GUESS THE INVENTION", eduo: "GUESS THE FAMOUS DUO", eartifact: "GUESS THE ARTIFACT", epainting: "GUESS THE PAINTING", ephobia: "GUESS THE PHOBIA", emascot: "GUESS THE BRAND MASCOT", einstrument: "GUESS THE INSTRUMENT", emovie3: "GUESS THE MOVIE", egame3: "GUESS THE GAME", epower: "GUESS THE SUPERPOWER", esong3: "GUESS THE SONG", etv3: "GUESS THE TV SHOW", ebook3: "GUESS THE BOOK", ebrand3: "GUESS THE BRAND", efood3: "GUESS THE FOOD", eheroes2: "GUESS THE SUPERHERO", edisney2: "GUESS THE DISNEY", eanime2: "GUESS THE ANIME", ecartoon2: "GUESS THE CARTOON", emovie4: "GUESS THE MOVIE", esports2: "GUESS THE SPORT", elandmark: "GUESS THE LANDMARK", eanimal2: "GUESS THE ANIMAL", ejobs2: "GUESS THE JOB", emythcreature2: "GUESS THE MYTHICAL CREATURE", edessert2: "GUESS THE DESSERT", evehicle2: "GUESS THE VEHICLE", evillain2: "GUESS THE VILLAIN", eanimal3: "GUESS THE ANIMAL", efood4: "GUESS THE FOOD", esong4: "GUESS THE SONG", emovie5: "GUESS THE MOVIE", etv4: "GUESS THE TV SHOW", egame4: "GUESS THE GAME", eheroes3: "GUESS THE SUPERHERO", ebrand4: "GUESS THE BRAND", eanime3: "GUESS THE ANIME", edisney3: "GUESS THE DISNEY", ecartoon3: "GUESS THE CARTOON", ebook4: "GUESS THE BOOK", elandmark2: "GUESS THE LANDMARK", esport3: "GUESS THE SPORT", ejobs3: "GUESS THE JOB", efruit2: "GUESS THE FRUIT OR VEG", eseacreature2: "GUESS THE SEA CREATURE", einstrument2: "GUESS THE INSTRUMENT", evillain3: "GUESS THE VILLAIN", emythcreature3: "GUESS THE MYTHICAL CREATURE", eweather2: "GUESS THE WEATHER", edessert3: "GUESS THE DESSERT", evehicle3: "GUESS THE VEHICLE", eanimal4: "GUESS THE ANIMAL", efood5: "GUESS THE FOOD", esong5: "GUESS THE SONG", emovie6: "GUESS THE MOVIE", eholiday2: "GUESS THE HOLIDAY", eclothing2: "GUESS THE CLOTHING", etoy2: "GUESS THE TOY", ecity2: "GUESS THE CITY", edrink2: "GUESS THE DRINK", eboardgame2: "GUESS THE BOARD GAME", eanimal5: "GUESS THE ANIMAL", emovie7: "GUESS THE MOVIE", ecartoon4: "GUESS THE CARTOON", etv5: "GUESS THE TV SHOW", esong6: "GUESS THE SONG", ebrand5: "GUESS THE BRAND", evideogame5: "GUESS THE GAME", ebook5: "GUESS THE BOOK", edisney4: "GUESS THE DISNEY", esport4: "GUESS THE SPORT", efood6: "GUESS THE FOOD", eanime4: "GUESS THE ANIME", emovie8: "GUESS THE MOVIE", etv6: "GUESS THE TV SHOW", evillain4: "GUESS THE VILLAIN", esong7: "GUESS THE SONG", eanimal6: "GUESS THE ANIMAL", ebrand6: "GUESS THE BRAND", emovie9: "GUESS THE MOVIE", evideogame6: "GUESS THE GAME", ecartoon5: "GUESS THE CARTOON", esong8: "GUESS THE SONG", eanimal7: "GUESS THE ANIMAL", emovie10: "GUESS THE MOVIE" };
const voFile = (item, mode) => mode === "movies" ? `sfx/em-${item.id}.wav` : mode === "efoods" ? `sfx/ef-${item.id}.wav` : mode === "esongs" ? `sfx/es-${item.id}.wav` : mode === "egames" ? `sfx/eg-${item.id}.wav` : mode === "ecountries" ? `sfx/ec-${item.id}.wav` : mode === "ecountries2" ? `sfx/ce-${item.id}.wav` : mode === "etv" ? `sfx/et-${item.id}.wav` : mode === "ebrands" ? `sfx/eb-${item.id}.wav` : mode === "ebooks" ? `sfx/bk-${item.id}.wav` : mode === "carlogos" ? `sfx/cl-${item.slug}.wav` : mode === "gaming" ? `sfx/gm-${item.slug}.wav` : mode === "airlines" ? `sfx/al-${item.slug}.wav` : mode === "fastfood" ? `sfx/ff-${item.slug}.wav` : mode === "countryshapes" ? `sfx/cs-${item.slug}.wav` : mode === "countrymap" ? `sfx/wm-${item.slug}.wav` : mode === "usstates" ? `sfx/usst-${item.slug}.wav` : mode === "instruments" ? `sfx/mi-${item.slug}.wav` : mode === "fish" ? `sfx/fh-${item.slug}.wav` : mode === "fish2" ? `sfx/fs-${item.slug}.wav` : mode === "cocktails" ? `sfx/ck-${item.slug}.wav` : mode === "drinks" ? `sfx/dk-${item.slug}.wav` : mode === "breads" ? `sfx/br-${item.slug}.wav` : mode === "nuts" ? `sfx/nt-${item.slug}.wav` : mode === "cacti" ? `sfx/cx-${item.slug}.wav` : mode === "desserts" ? `sfx/ds-${item.slug}.wav` : mode === "kitchen" ? `sfx/kt-${item.slug}.wav` : mode === "spices" ? `sfx/sc-${item.slug}.wav` : mode === "pasta" ? `sfx/pa-${item.slug}.wav` : mode === "cheese" ? `sfx/ch-${item.slug}.wav` : mode === "trains" ? `sfx/tn-${item.slug}.wav` : mode === "primates" ? `sfx/pr-${item.slug}.wav` : mode === "boats" ? `sfx/bt-${item.slug}.wav` : mode === "shells" ? `sfx/sh-${item.slug}.wav` : mode === "mushrooms" ? `sfx/mu-${item.slug}.wav` : mode === "mushrooms2" ? `sfx/mu2-${item.slug}.wav` : mode === "aircraft" ? `sfx/ac-${item.slug}.wav` : mode === "space" ? `sfx/sp-${item.slug}.wav` : mode === "sports" ? `sfx/sr-${item.slug}.wav` : mode === "trees" ? `sfx/tr-${item.slug}.wav` : mode === "tools" ? `sfx/tl-${item.slug}.wav` : mode === "rocks" ? `sfx/rk-${item.slug}.wav` : mode === "hats" ? `sfx/ht-${item.slug}.wav` : mode === "reptiles" ? `sfx/rp-${item.slug}.wav` : mode === "reptiles2" ? `sfx/rp2-${item.slug}.wav` : mode === "silhouette" ? `sfx/sl-${item.slug}.wav` : mode === "dinosilhouette" ? `sfx/dz-${item.slug}.wav` : mode === "animals2" ? `sfx/a2-${item.slug}.wav` : mode === "animals3" ? `sfx/a3-${item.slug}.wav` : mode === "landmarks2" ? `sfx/l2-${item.slug}.wav` : mode === "spiders" ? `sfx/sd-${item.slug}.wav` : mode === "amphibians" ? `sfx/am-${item.slug}.wav` : mode === "horses" ? `sfx/hr-${item.slug}.wav` : mode === "gems" ? `sfx/gem-${item.slug}.wav` : mode === "insects" ? `sfx/in-${item.slug}.wav` : mode === "insects2" ? `sfx/i2-${item.slug}.wav` : mode === "cats" ? `sfx/cat-${item.slug}.wav` : mode === "clubs" ? `sfx/cb-${item.slug}.wav` : mode === "clubbadges" ? `sfx/fc-${item.slug}.wav` : mode === "logos" ? `sfx/nm-${item.slug}.wav` : mode === "natteams" ? `sfx/nt-${item.slug}.wav` : mode === "coatofarms" ? `sfx/coa-${item.slug}.wav` : mode === "animals" ? `sfx/an-${item.slug}.wav` : mode === "foods2" ? `sfx/f2-${item.slug}.wav` : mode === "foods" ? `sfx/fd-${item.slug}.wav` : mode === "dogs" ? `sfx/dog-${item.slug}.wav` : mode === "dogs2" ? `sfx/d2-${item.slug}.wav` : mode === "cars" ? `sfx/cm-${item.slug}.wav` : mode === "cars2" ? `sfx/c2-${item.slug}.wav` : mode === "birds" ? `sfx/bd-${item.slug}.wav` : mode === "birds2" ? `sfx/b2-${item.slug}.wav` : mode === "sea" ? `sfx/sc-${item.slug}.wav` : mode === "sea2" ? `sfx/se2-${item.slug}.wav` : mode === "fruits" ? `sfx/fr-${item.slug}.wav` : mode === "flowers" ? `sfx/fl-${item.slug}.wav` : mode === "flowers2" ? `sfx/w2-${item.slug}.wav` : mode === "butterflies" ? `sfx/bt-${item.slug}.wav` : mode === "butterflies2" ? `sfx/bf2-${item.slug}.wav` : mode === "snakes" ? `sfx/sn-${item.slug}.wav` : mode === "dinos" ? `sfx/dn-${item.slug}.wav` : mode === "paintings" ? `sfx/pt-${item.slug}.wav` : mode === "flagzoom" ? `sfx/fz-${item.slug}.wav` : mode === "landmarkzoom" ? `sfx/lz-${item.slug}.wav` : mode === "foodzoom" ? `sfx/fz2-${item.slug}.wav` : mode === "flagsmega" ? `sfx/fm-${item.slug}.wav` : mode === "capitals" ? `sfx/cp-${item.iso}.wav` : mode === "scrambled" ? `sfx/scr-${item.slug}.wav` : mode === "novowels" ? `sfx/nvw-${item.slug}.wav` : mode === "reversed" ? `sfx/rev-${item.slug}.wav` : mode === "capitalscrambled" ? `sfx/cscr-${item.slug}.wav` : mode === "usstatescrambled" ? `sfx/ussc-${item.slug}.wav` : mode === "missingletters" ? `sfx/mis-${item.slug}.wav` : mode === "emojiword" ? `sfx/ew-${item.slug}.wav` : mode === "slogan" ? `sfx/bs-${item.slug}.wav` : mode === "esongs2" ? `sfx/esg2-${item.id}.wav` : mode === "movies2" ? `sfx/me2-${item.id}.wav` : mode === "egames2" ? `sfx/eg2-${item.id}.wav` : mode === "etv2" ? `sfx/et2-${item.id}.wav` : mode === "ebooks2" ? `sfx/bk2-${item.id}.wav` : mode === "ebrands2" ? `sfx/eb2-${item.id}.wav` : mode === "efoods2" ? `sfx/ef2-${item.id}.wav` : mode === "eheroes" ? `sfx/eh2-${item.id}.wav` : mode === "edisney" ? `sfx/ed2-${item.id}.wav` : mode === "eanime" ? `sfx/ea2-${item.id}.wav` : mode === "eanimal" ? `sfx/e134-${item.id}.wav` : mode === "esports" ? `sfx/e135-${item.id}.wav` : mode === "ejobs" ? `sfx/e136-${item.id}.wav` : mode === "ecartoon" ? `sfx/e137-${item.id}.wav` : mode === "efairytale" ? `sfx/e138-${item.id}.wav` : mode === "eband" ? `sfx/e139-${item.id}.wav` : mode === "efruit" ? `sfx/e140-${item.id}.wav` : mode === "eboardgame" ? `sfx/e141-${item.id}.wav` : mode === "evehicle" ? `sfx/e142-${item.id}.wav` : mode === "eholiday" ? `sfx/e143-${item.id}.wav` : mode === "emythcreature" ? `sfx/e144-${item.id}.wav` : mode === "eweather" ? `sfx/e145-${item.id}.wav` : mode === "eancientgod" ? `sfx/e146-${item.id}.wav` : mode === "ehobby" ? `sfx/e147-${item.id}.wav` : mode === "ecity" ? `sfx/e148-${item.id}.wav` : mode === "edance" ? `sfx/e149-${item.id}.wav` : mode === "eseacreature" ? `sfx/e150-${item.id}.wav` : mode === "eclothing" ? `sfx/e151-${item.id}.wav` : mode === "edrink" ? `sfx/e152-${item.id}.wav` : mode === "egamechar" ? `sfx/e153-${item.id}.wav` : mode === "evillain" ? `sfx/e154-${item.id}.wav` : mode === "etoy" ? `sfx/e155-${item.id}.wav` : mode === "eanimechar" ? `sfx/e156-${item.id}.wav` : mode === "erhyme" ? `sfx/e157-${item.id}.wav` : mode === "edessert" ? `sfx/e158-${item.id}.wav` : mode === "eplace" ? `sfx/e159-${item.id}.wav` : mode === "escientist" ? `sfx/e160-${item.id}.wav` : mode === "einvention" ? `sfx/e161-${item.id}.wav` : mode === "eduo" ? `sfx/e162-${item.id}.wav` : mode === "eartifact" ? `sfx/e163-${item.id}.wav` : mode === "epainting" ? `sfx/e164-${item.id}.wav` : mode === "ephobia" ? `sfx/e165-${item.id}.wav` : mode === "emascot" ? `sfx/e166-${item.id}.wav` : mode === "einstrument" ? `sfx/e167-${item.id}.wav` : mode === "emovie3" ? `sfx/e168-${item.id}.wav` : mode === "egame3" ? `sfx/e169-${item.id}.wav` : mode === "epower" ? `sfx/e170-${item.id}.wav` : mode === "esong3" ? `sfx/e171-${item.id}.wav` : mode === "etv3" ? `sfx/e172-${item.id}.wav` : mode === "ebook3" ? `sfx/e173-${item.id}.wav` : mode === "ebrand3" ? `sfx/e174-${item.id}.wav` : mode === "efood3" ? `sfx/e175-${item.id}.wav` : mode === "eheroes2" ? `sfx/e176-${item.id}.wav` : mode === "edisney2" ? `sfx/e177-${item.id}.wav` : mode === "eanime2" ? `sfx/e178-${item.id}.wav` : mode === "ecartoon2" ? `sfx/e179-${item.id}.wav` : mode === "emovie4" ? `sfx/e180-${item.id}.wav` : mode === "esports2" ? `sfx/e181-${item.id}.wav` : mode === "elandmark" ? `sfx/e182-${item.id}.wav` : mode === "eanimal2" ? `sfx/e183-${item.id}.wav` : mode === "ejobs2" ? `sfx/e184-${item.id}.wav` : mode === "emythcreature2" ? `sfx/e185-${item.id}.wav` : mode === "edessert2" ? `sfx/e186-${item.id}.wav` : mode === "evehicle2" ? `sfx/e187-${item.id}.wav` : mode === "evillain2" ? `sfx/e188-${item.id}.wav` : mode === "eanimal3" ? `sfx/e189-${item.id}.wav` : mode === "efood4" ? `sfx/e190-${item.id}.wav` : mode === "esong4" ? `sfx/e191-${item.id}.wav` : mode === "emovie5" ? `sfx/e192-${item.id}.wav` : mode === "etv4" ? `sfx/e193-${item.id}.wav` : mode === "egame4" ? `sfx/e194-${item.id}.wav` : mode === "eheroes3" ? `sfx/e195-${item.id}.wav` : mode === "ebrand4" ? `sfx/e196-${item.id}.wav` : mode === "eanime3" ? `sfx/e197-${item.id}.wav` : mode === "edisney3" ? `sfx/e198-${item.id}.wav` : mode === "ecartoon3" ? `sfx/e199-${item.id}.wav` : mode === "ebook4" ? `sfx/e200-${item.id}.wav` : mode === "elandmark2" ? `sfx/e201-${item.id}.wav` : mode === "esport3" ? `sfx/e202-${item.id}.wav` : mode === "ejobs3" ? `sfx/e203-${item.id}.wav` : mode === "efruit2" ? `sfx/e204-${item.id}.wav` : mode === "eseacreature2" ? `sfx/e205-${item.id}.wav` : mode === "einstrument2" ? `sfx/e206-${item.id}.wav` : mode === "evillain3" ? `sfx/e207-${item.id}.wav` : mode === "emythcreature3" ? `sfx/e208-${item.id}.wav` : mode === "eweather2" ? `sfx/e209-${item.id}.wav` : mode === "edessert3" ? `sfx/e210-${item.id}.wav` : mode === "evehicle3" ? `sfx/e211-${item.id}.wav` : mode === "eanimal4" ? `sfx/e212-${item.id}.wav` : mode === "efood5" ? `sfx/e213-${item.id}.wav` : mode === "esong5" ? `sfx/e214-${item.id}.wav` : mode === "emovie6" ? `sfx/e215-${item.id}.wav` : mode === "eholiday2" ? `sfx/e216-${item.id}.wav` : mode === "eclothing2" ? `sfx/e217-${item.id}.wav` : mode === "etoy2" ? `sfx/e218-${item.id}.wav` : mode === "ecity2" ? `sfx/e219-${item.id}.wav` : mode === "edrink2" ? `sfx/e220-${item.id}.wav` : mode === "eboardgame2" ? `sfx/e221-${item.id}.wav` : mode === "eanimal5" ? `sfx/e222-${item.id}.wav` : mode === "emovie7" ? `sfx/e223-${item.id}.wav` : mode === "ecartoon4" ? `sfx/e224-${item.id}.wav` : mode === "etv5" ? `sfx/e225-${item.id}.wav` : mode === "esong6" ? `sfx/e226-${item.id}.wav` : mode === "ebrand5" ? `sfx/e227-${item.id}.wav` : mode === "evideogame5" ? `sfx/e228-${item.id}.wav` : mode === "ebook5" ? `sfx/e229-${item.id}.wav` : mode === "edisney4" ? `sfx/e230-${item.id}.wav` : mode === "esport4" ? `sfx/e231-${item.id}.wav` : mode === "efood6" ? `sfx/e232-${item.id}.wav` : mode === "eanime4" ? `sfx/e233-${item.id}.wav` : mode === "emovie8" ? `sfx/e234-${item.id}.wav` : mode === "etv6" ? `sfx/e235-${item.id}.wav` : mode === "evillain4" ? `sfx/e236-${item.id}.wav` : mode === "esong7" ? `sfx/e237-${item.id}.wav` : mode === "eanimal6" ? `sfx/e238-${item.id}.wav` : mode === "ebrand6" ? `sfx/e239-${item.id}.wav` : mode === "emovie9" ? `sfx/e240-${item.id}.wav` : mode === "evideogame6" ? `sfx/e241-${item.id}.wav` : mode === "ecartoon5" ? `sfx/e242-${item.id}.wav` : mode === "esong8" ? `sfx/e243-${item.id}.wav` : mode === "eanimal7" ? `sfx/e244-${item.id}.wav` : mode === "emovie10" ? `sfx/e245-${item.id}.wav` : `sfx/fl-${item.iso}.wav`;
const answer = (item, mode) => mode === "emojiword" ? item.answer : (mode === "paintings" || mode === "movies" || mode === "efoods" || mode === "esongs" || mode === "egames" || mode === "ecountries" || mode === "ecountries2" || mode === "etv" || mode === "ebrands" || mode === "ebooks" || mode === "esongs2" || mode === "movies2" || mode === "egames2" || mode === "etv2" || mode === "ebooks2" || mode === "ebrands2" || mode === "efoods2" || mode === "eheroes" || mode === "edisney" || mode === "eanime" || mode === "eanimal" || mode === "esports" || mode === "ejobs" || mode === "ecartoon" || mode === "efairytale" || mode === "eband" || mode === "efruit" || mode === "eboardgame" || mode === "evehicle" || mode === "eholiday" || mode === "emythcreature" || mode === "eweather" || mode === "eancientgod" || mode === "ehobby" || mode === "ecity" || mode === "edance" || mode === "eseacreature" || mode === "eclothing" || mode === "edrink" || mode === "egamechar" || mode === "evillain" || mode === "etoy" || mode === "eanimechar" || mode === "erhyme" || mode === "edessert" || mode === "eplace" || mode === "escientist" || mode === "einvention" || mode === "eduo" || mode === "eartifact" || mode === "epainting" || mode === "ephobia" || mode === "emascot" || mode === "einstrument" || mode === "emovie3" || mode === "egame3" || mode === "epower" || mode === "esong3" || mode === "etv3" || mode === "ebook3" || mode === "ebrand3" || mode === "efood3" || mode === "eheroes2" || mode === "edisney2" || mode === "eanime2" || mode === "ecartoon2" || mode === "emovie4" || mode === "esports2" || mode === "elandmark" || mode === "eanimal2" || mode === "ejobs2" || mode === "emythcreature2" || mode === "edessert2" || mode === "evehicle2" || mode === "evillain2" || mode === "eanimal3" || mode === "efood4" || mode === "esong4" || mode === "emovie5" || mode === "etv4" || mode === "egame4" || mode === "eheroes3" || mode === "ebrand4" || mode === "eanime3" || mode === "edisney3" || mode === "ecartoon3" || mode === "ebook4" || mode === "elandmark2" || mode === "esport3" || mode === "ejobs3" || mode === "efruit2" || mode === "eseacreature2" || mode === "einstrument2" || mode === "evillain3" || mode === "emythcreature3" || mode === "eweather2" || mode === "edessert3" || mode === "evehicle3" || mode === "eanimal4" || mode === "efood5" || mode === "esong5" || mode === "emovie6" || mode === "eholiday2" || mode === "eclothing2" || mode === "etoy2" || mode === "ecity2" || mode === "edrink2" || mode === "eboardgame2" || mode === "eanimal5" || mode === "emovie7" || mode === "ecartoon4" || mode === "etv5" || mode === "esong6" || mode === "ebrand5" || mode === "evideogame5" || mode === "ebook5" || mode === "edisney4" || mode === "esport4" || mode === "efood6" || mode === "eanime4" || mode === "emovie8" || mode === "etv6" || mode === "evillain4" || mode === "esong7" || mode === "eanimal6" || mode === "ebrand6" || mode === "emovie9" || mode === "evideogame6" || mode === "ecartoon5" || mode === "esong8" || mode === "eanimal7" || mode === "emovie10") ? item.title : (mode === "logos" || mode === "natteams" || mode === "clubs" || mode === "clubbadges" || mode === "animals" || mode === "foods" || mode === "foods2" || mode === "dogs" || mode === "dogs2" || mode === "cars" || mode === "cars2" || mode === "birds" || mode === "birds2" || mode === "sea" || mode === "sea2" || mode === "fruits" || mode === "flowers" || mode === "flowers2" || mode === "butterflies" || mode === "butterflies2" || mode === "snakes" || mode === "dinos" || mode === "carlogos" || mode === "gaming" || mode === "airlines" || mode === "fastfood" || mode === "fish" || mode === "fish2" || mode === "cocktails" || mode === "drinks" || mode === "breads" || mode === "nuts" || mode === "cacti" || mode === "desserts" || mode === "kitchen" || mode === "spices" || mode === "pasta" || mode === "cheese" || mode === "trains" || mode === "primates" || mode === "boats" || mode === "shells" || mode === "mushrooms" || mode === "mushrooms2" || mode === "aircraft" || mode === "space" || mode === "sports" || mode === "trees" || mode === "tools" || mode === "rocks" || mode === "hats" || mode === "reptiles2" || mode === "reptiles" || mode === "silhouette" || mode === "dinosilhouette" || mode === "animals2" || mode === "animals3" || mode === "landmarks2" || mode === "spiders" || mode === "amphibians" || mode === "horses" || mode === "gems" || mode === "insects" || mode === "insects2" || mode === "cats" || mode === "countryshapes" || mode === "countrymap" || mode === "usstates" || mode === "instruments" || mode === "landmarkzoom" || mode === "foodzoom") ? item.name : mode === "capitals" ? item.capital : item.country || item.name;
