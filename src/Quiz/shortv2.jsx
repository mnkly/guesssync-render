...
const ABCD = ["A", "B", "C", "D"];
const nameOf = (x, mode) => (mode === "paintings" || mode === "movies" || mode === "efoods" || mode === "esongs" || mode === "egames" || mode === "ecountries" || mode === "ecountries2" || mode === "etv" || mode === "ebrands" || mode === "ebooks") ? x.title : mode === "capitals" ? x.capital : (x.name || x.country || x.slug);
