...
const Clue = ({ item, mode, revealed, accent, zoom }) => {
  ...
  // below is untouched.
  if (mode === "scrambled" || mode === "novowels") {
    const text = mode === "novowels" ? item.novowels : item.scrambled;
