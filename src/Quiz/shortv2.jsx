...
const ABCD = ["A", "B", "C", "D"];
const nameOf = (x, mode) => (mode === "paintings" || mode === "movies" || mode === "efoods" || mode === "esongs" || mode === "egames" || mode === "ecountries") ? x.title : mode === "capitals" ? x.capital : (x.name || x.country || x.slug);
