...
export const FLAG_FRAMES = build(FLAGS).total;
export const FLAG_SAMPLE_FRAMES = build(FLAGS.slice(0, 6)).total;
export const FlagQuizGS = () => <Comp flags={FLAGS} />;
export const FlagQuizGSSample = () => <Comp flags={FLAGS.slice(0, 6)} />;
