...
export const LOGO_FRAMES = build(LOGOS).total;
export const LOGO_SAMPLE_FRAMES = build(LOGOS.slice(0, 6)).total;
export const LogoQuiz = () => <Comp logos={LOGOS} />;
export const LogoQuizSample = () => <Comp logos={LOGOS.slice(0, 6)} />;
